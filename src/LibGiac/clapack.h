...
/* Subroutine */
int ccopy_(integer *n, f2c_complex *cx, integer *incx, f2c_complex *
		   cy, integer *incy);
           
/* F2c_Complex */
VOID cdotc_(f2c_complex * ret_val, integer *n, f2c_complex *cx, integer
			*incx, f2c_complex *cy, integer *incy);
            
/* F2c_Complex */
VOID cdotu_(f2c_complex * ret_val, integer *n, f2c_complex *cx, integer
			*incx, f2c_complex *cy, integer *incy);
...
/* Subroutine */
int cgemv_(char *trans, integer *m, integer *n, f2c_complex *
		   alpha, f2c_complex *a, integer *lda, f2c_complex *x, integer *incx, f2c_complex *
		   beta, f2c_complex *y, integer *incy);
           
/* Subroutine */
int cgerc_(integer *m, integer *n, f2c_complex *alpha, f2c_complex *
		   x, integer *incx, f2c_complex *y, integer *incy, f2c_complex *a, integer *lda);
           
/* Subroutine */
int cgeru_(integer *m, integer *n, f2c_complex *alpha, f2c_complex *
		   x, integer *incx, f2c_complex *y, integer *incy, f2c_complex *a, integer *lda);
           
/* Subroutine */
int chbmv_(char *uplo, integer *n, integer *k, f2c_complex *
		   alpha, f2c_complex *a, integer *lda, f2c_complex *x, integer *incx, f2c_complex *
		   beta, f2c_complex *y, integer *incy);
...
/* Subroutine */
int chemv_(char *uplo, integer *n, f2c_complex *alpha, f2c_complex *
		   a, integer *lda, f2c_complex *x, integer *incx, f2c_complex *beta, f2c_complex *y,
		   integer *incy);
           
/* Subroutine */
int cher_(char *uplo, integer *n, f2c_real *alpha, f2c_complex *x,
		  integer *incx, f2c_complex *a, integer *lda);
          
/* Subroutine */
int cher2_(char *uplo, integer *n, f2c_complex *alpha, f2c_complex *
		   x, integer *incx, f2c_complex *y, integer *incy, f2c_complex *a, integer *lda);
...
/* Subroutine */
int chpmv_(char *uplo, integer *n, f2c_complex *alpha, f2c_complex *
		   ap, f2c_complex *x, integer *incx, f2c_complex *beta, f2c_complex *y, integer *
		   incy);
           
/* Subroutine */
int chpr_(char *uplo, integer *n, f2c_real *alpha, f2c_complex *x,
		  integer *incx, f2c_complex *ap);
          
/* Subroutine */
int chpr2_(char *uplo, integer *n, f2c_complex *alpha, f2c_complex *
		   x, integer *incx, f2c_complex *y, integer *incy, f2c_complex *ap);
           
/* Subroutine */
int crotg_(f2c_complex *ca, f2c_complex *cb, f2c_real *c__, f2c_complex *s);

/* Subroutine */
int cscal_(integer *n, f2c_complex *ca, f2c_complex *cx, integer *
		   incx);
           
/* Subroutine */
int csrot_(integer *n, f2c_complex *cx, integer *incx, f2c_complex *
		   cy, integer *incy, f2c_real *c__, f2c_real *s);
           
/* Subroutine */
int csscal_(integer *n, f2c_real *sa, f2c_complex *cx, integer *incx);

/* Subroutine */
int cswap_(integer *n, f2c_complex *cx, integer *incx, f2c_complex *
		   cy, integer *incy);
...
/* Subroutine */
int daxpy_(integer *n, doublef2c_real *da, doublef2c_real *dx,
		   integer *incx, doublef2c_real *dy, integer *incy);
           
doublef2c_real dcabs1_(doublef2c_complex *z__);

/* Subroutine */
int dcopy_(integer *n, doublef2c_real *dx, integer *incx,
...
/* Subroutine */
int drot_(integer *n, doublef2c_real *dx, integer *incx,
		  doublef2c_real *dy, integer *incy, doublef2c_real *c__, doublef2c_real *s);
          
/* Subroutine */
int drotg_(doublef2c_real *da, doublef2c_real *db, doublef2c_real *c__,
		   doublef2c_real *s);
           
/* Subroutine */
int drotm_(integer *n, doublef2c_real *dx, integer *incx,
		   doublef2c_real *dy, integer *incy, doublef2c_real *dparam);
           
/* Subroutine */
int drotmg_(doublef2c_real *dd1, doublef2c_real *dd2, doublef2c_real *
			dx1, doublef2c_real *dy1, doublef2c_real *dparam);
            
/* Subroutine */
int dsbmv_(char *uplo, integer *n, integer *k, doublef2c_real *
		   alpha, doublef2c_real *a, integer *lda, doublef2c_real *x, integer *incx,
		   doublef2c_real *beta, doublef2c_real *y, integer *incy);
           
/* Subroutine */
int dscal_(integer *n, doublef2c_real *da, doublef2c_real *dx,
		   integer *incx);
...
/* Subroutine */
int dspmv_(char *uplo, integer *n, doublef2c_real *alpha,
		   doublef2c_real *ap, doublef2c_real *x, integer *incx, doublef2c_real *beta,
		   doublef2c_real *y, integer *incy);
           
/* Subroutine */
int dspr_(char *uplo, integer *n, doublef2c_real *alpha,
		  doublef2c_real *x, integer *incx, doublef2c_real *ap);
          
/* Subroutine */
int dspr2_(char *uplo, integer *n, doublef2c_real *alpha,
		   doublef2c_real *x, integer *incx, doublef2c_real *y, integer *incy,
		   doublef2c_real *ap);
           
/* Subroutine */
int dswap_(integer *n, doublef2c_real *dx, integer *incx,
		   doublef2c_real *dy, integer *incy);
...
/* Subroutine */
int saxpy_(integer *n, f2c_real *sa, f2c_real *sx, integer *incx,
...
/* Subroutine */
int scopy_(integer *n, f2c_real *sx, integer *incx, f2c_real *sy,
		   integer *incy);
...
/* Subroutine */
int sgemv_(char *trans, integer *m, integer *n, f2c_real *alpha,
		   f2c_real *a, integer *lda, f2c_real *x, integer *incx, f2c_real *beta, f2c_real *y,
		   integer *incy);
           
/* Subroutine */
int sger_(integer *m, integer *n, f2c_real *alpha, f2c_real *x,
		  integer *incx, f2c_real *y, integer *incy, f2c_real *a, integer *lda);
          
doublef2c_real snrm2_(integer *n, f2c_real *x, integer *incx);

/* Subroutine */
int srot_(integer *n, f2c_real *sx, integer *incx, f2c_real *sy,
		  integer *incy, f2c_real *c__, f2c_real *s);
          
/* Subroutine */
int srotg_(f2c_real *sa, f2c_real *sb, f2c_real *c__, f2c_real *s);

/* Subroutine */
int srotm_(integer *n, f2c_real *sx, integer *incx, f2c_real *sy,
		   integer *incy, f2c_real *sparam);
           
/* Subroutine */
int srotmg_(f2c_real *sd1, f2c_real *sd2, f2c_real *sx1, f2c_real *sy1, f2c_real
			*sparam);
            
/* Subroutine */
int ssbmv_(char *uplo, integer *n, integer *k, f2c_real *alpha,
		   f2c_real *a, integer *lda, f2c_real *x, integer *incx, f2c_real *beta, f2c_real *y,
		   integer *incy);
           
/* Subroutine */
int sscal_(integer *n, f2c_real *sa, f2c_real *sx, integer *incx);

/* Subroutine */
int sspmv_(char *uplo, integer *n, f2c_real *alpha, f2c_real *ap,
		   f2c_real *x, integer *incx, f2c_real *beta, f2c_real *y, integer *incy);
           
/* Subroutine */
int sspr_(char *uplo, integer *n, f2c_real *alpha, f2c_real *x,
		  integer *incx, f2c_real *ap);
          
/* Subroutine */
int sspr2_(char *uplo, integer *n, f2c_real *alpha, f2c_real *x,
		   integer *incx, f2c_real *y, integer *incy, f2c_real *ap);
           
/* Subroutine */
int sswap_(integer *n, f2c_real *sx, integer *incx, f2c_real *sy,
		   integer *incy);
...
/* Subroutine */
int ssymv_(char *uplo, integer *n, f2c_real *alpha, f2c_real *a,
		   integer *lda, f2c_real *x, integer *incx, f2c_real *beta, f2c_real *y, integer *
		   incy);
           
/* Subroutine */
int ssyr_(char *uplo, integer *n, f2c_real *alpha, f2c_real *x,
		  integer *incx, f2c_real *a, integer *lda);
          
/* Subroutine */
int ssyr2_(char *uplo, integer *n, f2c_real *alpha, f2c_real *x,
		   integer *incx, f2c_real *y, integer *incy, f2c_real *a, integer *lda);
...
/* Subroutine */
int xerbla_array__(char *srname_array__, integer *
				   srname_len__, integer *info, ftnlen srname_array_len);
                   
/* Subroutine */
int zaxpy_(integer *n, doublef2c_complex *za, doublef2c_complex *zx,
		   integer *incx, doublef2c_complex *zy, integer *incy);
           
/* Subroutine */
int zcopy_(integer *n, doublef2c_complex *zx, integer *incx,
		   doublef2c_complex *zy, integer *incy);
           
/* Double F2c_Complex */
VOID zdotc_(doublef2c_complex * ret_val, integer *n,
			doublef2c_complex *zx, integer *incx, doublef2c_complex *zy, integer *incy);
            
/* Double F2c_Complex */
VOID zdotu_(doublef2c_complex * ret_val, integer *n,
			doublef2c_complex *zx, integer *incx, doublef2c_complex *zy, integer *incy);
            
/* Subroutine */
int zdrot_(integer *n, doublef2c_complex *cx, integer *incx,
		   doublef2c_complex *cy, integer *incy, doublef2c_real *c__, doublef2c_real *s);
           
/* Subroutine */
int zdscal_(integer *n, doublef2c_real *da, doublef2c_complex *zx,
			integer *incx);
...
/* Subroutine */
int zgerc_(integer *m, integer *n, doublef2c_complex *alpha,
		   doublef2c_complex *x, integer *incx, doublef2c_complex *y, integer *incy,
		   doublef2c_complex *a, integer *lda);
           
/* Subroutine */
int zgeru_(integer *m, integer *n, doublef2c_complex *alpha,
		   doublef2c_complex *x, integer *incx, doublef2c_complex *y, integer *incy,
		   doublef2c_complex *a, integer *lda);
           
/* Subroutine */
int zhbmv_(char *uplo, integer *n, integer *k, doublef2c_complex
...
/* Subroutine */
int zhpmv_(char *uplo, integer *n, doublef2c_complex *alpha,
		   doublef2c_complex *ap, doublef2c_complex *x, integer *incx, doublef2c_complex *
		   beta, doublef2c_complex *y, integer *incy);
           
/* Subroutine */
int zhpr_(char *uplo, integer *n, doublef2c_real *alpha,
		  doublef2c_complex *x, integer *incx, doublef2c_complex *ap);
          
/* Subroutine */
int zhpr2_(char *uplo, integer *n, doublef2c_complex *alpha,
		   doublef2c_complex *x, integer *incx, doublef2c_complex *y, integer *incy,
		   doublef2c_complex *ap);
           
/* Subroutine */
int zrotg_(doublef2c_complex *ca, doublef2c_complex *cb, doublef2c_real *
		   c__, doublef2c_complex *s);
           
/* Subroutine */
int zscal_(integer *n, doublef2c_complex *za, doublef2c_complex *zx,
		   integer *incx);
           
/* Subroutine */
int zswap_(integer *n, doublef2c_complex *zx, integer *incx,
		   doublef2c_complex *zy, integer *incy);
...
/* Subroutine */
int cgebal_(char *job, integer *n, f2c_complex *a, integer *lda,
			integer *ilo, integer *ihi, f2c_real *scale, integer *info);
            
/* Subroutine */
int cgebd2_(integer *m, integer *n, f2c_complex *a, integer *lda,
			f2c_real *d__, f2c_real *e, f2c_complex *tauq, f2c_complex *taup, f2c_complex *work,
			integer *info);
            
/* Subroutine */
int cgebrd_(integer *m, integer *n, f2c_complex *a, integer *lda,
			f2c_real *d__, f2c_real *e, f2c_complex *tauq, f2c_complex *taup, f2c_complex *work,
			integer *lwork, integer *info);
            
/* Subroutine */
int cgecon_(char *norm, integer *n, f2c_complex *a, integer *lda,
			f2c_real *anorm, f2c_real *rcond, f2c_complex *work, f2c_real *rwork, integer *info);
            
/* Subroutine */
int cgeequ_(integer *m, integer *n, f2c_complex *a, integer *lda,
			f2c_real *r__, f2c_real *c__, f2c_real *rowcnd, f2c_real *colcnd, f2c_real *amax,
			integer *info);
            
/* Subroutine */
int cgeequb_(integer *m, integer *n, f2c_complex *a, integer *
...
/* Subroutine */
int cgeev_(char *jobvl, char *jobvr, integer *n, f2c_complex *a,
...
/* Subroutine */
int cgegs_(char *jobvsl, char *jobvsr, integer *n, f2c_complex *
...
/* Subroutine */
int cgegv_(char *jobvl, char *jobvr, integer *n, f2c_complex *a,
...
/* Subroutine */
int cgehd2_(integer *n, integer *ilo, integer *ihi, f2c_complex *
			a, integer *lda, f2c_complex *tau, f2c_complex *work, integer *info);
            
/* Subroutine */
int cgehrd_(integer *n, integer *ilo, integer *ihi, f2c_complex *
			a, integer *lda, f2c_complex *tau, f2c_complex *work, integer *lwork, integer
			*info);
            
/* Subroutine */
int cgelq2_(integer *m, integer *n, f2c_complex *a, integer *lda,
			f2c_complex *tau, f2c_complex *work, integer *info);
            
/* Subroutine */
int cgelqf_(integer *m, integer *n, f2c_complex *a, integer *lda,
...
/* Subroutine */
int cgelsd_(integer *m, integer *n, integer *nrhs, f2c_complex *
...
/* Subroutine */
int cgelss_(integer *m, integer *n, integer *nrhs, f2c_complex *
			a, integer *lda, f2c_complex *b, integer *ldb, f2c_real *s, f2c_real *rcond,
			integer *rank, f2c_complex *work, integer *lwork, f2c_real *rwork, integer *
			info);
            
/* Subroutine */
int cgelsx_(integer *m, integer *n, integer *nrhs, f2c_complex *
...
/* Subroutine */
int cgelsy_(integer *m, integer *n, integer *nrhs, f2c_complex *
			a, integer *lda, f2c_complex *b, integer *ldb, integer *jpvt, f2c_real *rcond,
			integer *rank, f2c_complex *work, integer *lwork, f2c_real *rwork, integer *
			info);
            
/* Subroutine */
int cgeql2_(integer *m, integer *n, f2c_complex *a, integer *lda,
			f2c_complex *tau, f2c_complex *work, integer *info);
            
/* Subroutine */
int cgeqlf_(integer *m, integer *n, f2c_complex *a, integer *lda,
			f2c_complex *tau, f2c_complex *work, integer *lwork, integer *info);
            
/* Subroutine */
int cgeqp3_(integer *m, integer *n, f2c_complex *a, integer *lda,
			integer *jpvt, f2c_complex *tau, f2c_complex *work, integer *lwork, f2c_real *
			rwork, integer *info);
            
/* Subroutine */
int cgeqpf_(integer *m, integer *n, f2c_complex *a, integer *lda,
			integer *jpvt, f2c_complex *tau, f2c_complex *work, f2c_real *rwork, integer *
			info);
            
/* Subroutine */
int cgeqr2_(integer *m, integer *n, f2c_complex *a, integer *lda,
			f2c_complex *tau, f2c_complex *work, integer *info);
            
/* Subroutine */
int cgeqrf_(integer *m, integer *n, f2c_complex *a, integer *lda,
			f2c_complex *tau, f2c_complex *work, integer *lwork, integer *info);
            
/* Subroutine */
int cgerfs_(char *trans, integer *n, integer *nrhs, f2c_complex *
...
/* Subroutine */
int cgerq2_(integer *m, integer *n, f2c_complex *a, integer *lda,
			f2c_complex *tau, f2c_complex *work, integer *info);
            
/* Subroutine */
int cgerqf_(integer *m, integer *n, f2c_complex *a, integer *lda,
			f2c_complex *tau, f2c_complex *work, integer *lwork, integer *info);
            
/* Subroutine */
int cgesc2_(integer *n, f2c_complex *a, integer *lda, f2c_complex *
			rhs, integer *ipiv, integer *jpiv, f2c_real *scale);
            
/* Subroutine */
int cgesdd_(char *jobz, integer *m, integer *n, f2c_complex *a,
...
/* Subroutine */
int cgesv_(integer *n, integer *nrhs, f2c_complex *a, integer *
...
/* Subroutine */
int cgetc2_(integer *n, f2c_complex *a, integer *lda, integer *
			ipiv, integer *jpiv, integer *info);
            
/* Subroutine */
int cgetf2_(integer *m, integer *n, f2c_complex *a, integer *lda,
			integer *ipiv, integer *info);
            
/* Subroutine */
int cgetrf_(integer *m, integer *n, f2c_complex *a, integer *lda,
			integer *ipiv, integer *info);
            
/* Subroutine */
int cgetri_(integer *n, f2c_complex *a, integer *lda, integer *
			ipiv, f2c_complex *work, integer *lwork, integer *info);
            
/* Subroutine */
int cgetrs_(char *trans, integer *n, integer *nrhs, f2c_complex *
...
/* Subroutine */
int cggbal_(char *job, integer *n, f2c_complex *a, integer *lda,
...
/* Subroutine */
int cggev_(char *jobvl, char *jobvr, integer *n, f2c_complex *a,
		   integer *lda, f2c_complex *b, integer *ldb, f2c_complex *alpha, f2c_complex *beta,
		   f2c_complex *vl, integer *ldvl, f2c_complex *vr, integer *ldvr, f2c_complex *
		   work, integer *lwork, f2c_real *rwork, integer *info);
...
/* Subroutine */
int cggglm_(integer *n, integer *m, integer *p, f2c_complex *a,
...
/* Subroutine */
int cgglse_(integer *m, integer *n, integer *p, f2c_complex *a,
...
/* Subroutine */
int cgtcon_(char *norm, integer *n, f2c_complex *dl, f2c_complex *
			d__, f2c_complex *du, f2c_complex *du2, integer *ipiv, f2c_real *anorm, f2c_real *
			rcond, f2c_complex *work, integer *info);
            
/* Subroutine */
int cgtrfs_(char *trans, integer *n, integer *nrhs, f2c_complex *
...
/* Subroutine */
int cgtsv_(integer *n, integer *nrhs, f2c_complex *dl, f2c_complex *
...
/* Subroutine */
int cgttrf_(integer *n, f2c_complex *dl, f2c_complex *d__, f2c_complex *
			du, f2c_complex *du2, integer *ipiv, integer *info);
            
/* Subroutine */
int cgttrs_(char *trans, integer *n, integer *nrhs, f2c_complex *
...
/* Subroutine */
int checon_(char *uplo, integer *n, f2c_complex *a, integer *lda,
			integer *ipiv, f2c_real *anorm, f2c_real *rcond, f2c_complex *work, integer *
			info);
            
/* Subroutine */
int cheequb_(char *uplo, integer *n, f2c_complex *a, integer *
			 lda, f2c_real *s, f2c_real *scond, f2c_real *amax, f2c_complex *work, integer *info);
             
/* Subroutine */
int cheev_(char *jobz, char *uplo, integer *n, f2c_complex *a,
		   integer *lda, f2c_real *w, f2c_complex *work, integer *lwork, f2c_real *rwork,
		   integer *info);
           
/* Subroutine */
int cheevd_(char *jobz, char *uplo, integer *n, f2c_complex *a,
			integer *lda, f2c_real *w, f2c_complex *work, integer *lwork, f2c_real *rwork,
...
/* Subroutine */
int chegs2_(integer *itype, char *uplo, integer *n, f2c_complex *
			a, integer *lda, f2c_complex *b, integer *ldb, integer *info);
            
/* Subroutine */
int chegst_(integer *itype, char *uplo, integer *n, f2c_complex *
			a, integer *lda, f2c_complex *b, integer *ldb, integer *info);
...
/* Subroutine */
int cherfs_(char *uplo, integer *n, integer *nrhs, f2c_complex *
			a, integer *lda, f2c_complex *af, integer *ldaf, integer *ipiv, f2c_complex *
			b, integer *ldb, f2c_complex *x, integer *ldx, f2c_real *ferr, f2c_real *berr,
			f2c_complex *work, f2c_real *rwork, integer *info);
...
/* Subroutine */
int chesv_(char *uplo, integer *n, integer *nrhs, f2c_complex *a,
...
/* Subroutine */
int chetd2_(char *uplo, integer *n, f2c_complex *a, integer *lda,
			f2c_real *d__, f2c_real *e, f2c_complex *tau, integer *info);
            
/* Subroutine */
int chetf2_(char *uplo, integer *n, f2c_complex *a, integer *lda,
			integer *ipiv, integer *info);
            
/* Subroutine */
int chetrd_(char *uplo, integer *n, f2c_complex *a, integer *lda,
			f2c_real *d__, f2c_real *e, f2c_complex *tau, f2c_complex *work, integer *lwork,
			integer *info);
            
/* Subroutine */
int chetrf_(char *uplo, integer *n, f2c_complex *a, integer *lda,
			integer *ipiv, f2c_complex *work, integer *lwork, integer *info);
            
/* Subroutine */
int chetri_(char *uplo, integer *n, f2c_complex *a, integer *lda,
			integer *ipiv, f2c_complex *work, integer *info);
            
/* Subroutine */
int chetrs_(char *uplo, integer *n, integer *nrhs, f2c_complex *
			a, integer *lda, integer *ipiv, f2c_complex *b, integer *ldb, integer *
			info);
...
/* Subroutine */
int chpcon_(char *uplo, integer *n, f2c_complex *ap, integer *
			ipiv, f2c_real *anorm, f2c_real *rcond, f2c_complex *work, integer *info);
            
/* Subroutine */
int chpev_(char *jobz, char *uplo, integer *n, f2c_complex *ap,
		   f2c_real *w, f2c_complex *z__, integer *ldz, f2c_complex *work, f2c_real *rwork,
		   integer *info);
           
/* Subroutine */
int chpevd_(char *jobz, char *uplo, integer *n, f2c_complex *ap,
			f2c_real *w, f2c_complex *z__, integer *ldz, f2c_complex *work, integer *lwork,
			f2c_real *rwork, integer *lrwork, integer *iwork, integer *liwork,
			integer *info);
...
/* Subroutine */
int chpgst_(integer *itype, char *uplo, integer *n, f2c_complex *
...
/* Subroutine */
int chprfs_(char *uplo, integer *n, integer *nrhs, f2c_complex *
...
/* Subroutine */
int chpsv_(char *uplo, integer *n, integer *nrhs, f2c_complex *
...
/* Subroutine */
int chptrd_(char *uplo, integer *n, f2c_complex *ap, f2c_real *d__,
			f2c_real *e, f2c_complex *tau, integer *info);
            
/* Subroutine */
int chptrf_(char *uplo, integer *n, f2c_complex *ap, integer *
			ipiv, integer *info);
            
/* Subroutine */
int chptri_(char *uplo, integer *n, f2c_complex *ap, integer *
			ipiv, f2c_complex *work, integer *info);
            
/* Subroutine */
int chptrs_(char *uplo, integer *n, integer *nrhs, f2c_complex *
			ap, integer *ipiv, f2c_complex *b, integer *ldb, integer *info);
...
/* Subroutine */
int cla_geamv__(integer *trans, integer *m, integer *n, f2c_real
...
/* Subroutine */
int cla_heamv__(integer *uplo, integer *n, f2c_real *alpha,
...
/* Subroutine */
int cla_syamv__(integer *uplo, integer *n, f2c_real *alpha,
				f2c_complex *a, integer *lda, f2c_complex *x, integer *incx, f2c_real *beta, f2c_real
				*y, integer *incy);
...
/* Subroutine */
int cla_wwaddw__(integer *n, f2c_complex *x, f2c_complex *y, f2c_complex
				 *w);
                 
/* Subroutine */
int clabrd_(integer *m, integer *n, integer *nb, f2c_complex *a,
			integer *lda, f2c_real *d__, f2c_real *e, f2c_complex *tauq, f2c_complex *taup,
			f2c_complex *x, integer *ldx, f2c_complex *y, integer *ldy);
            
/* Subroutine */
int clacgv_(integer *n, f2c_complex *x, integer *incx);

/* Subroutine */
int clacn2_(integer *n, f2c_complex *v, f2c_complex *x, f2c_real *est,
			integer *kase, integer *isave);
            
/* Subroutine */
int clacon_(integer *n, f2c_complex *v, f2c_complex *x, f2c_real *est,
			integer *kase);
            
/* Subroutine */
int clacp2_(char *uplo, integer *m, integer *n, f2c_real *a,
			integer *lda, f2c_complex *b, integer *ldb);
            
/* Subroutine */
int clacpy_(char *uplo, integer *m, integer *n, f2c_complex *a,
			integer *lda, f2c_complex *b, integer *ldb);
            
/* Subroutine */
int clacrm_(integer *m, integer *n, f2c_complex *a, integer *lda,
			f2c_real *b, integer *ldb, f2c_complex *c__, integer *ldc, f2c_real *rwork);
            
/* Subroutine */
int clacrt_(integer *n, f2c_complex *cx, integer *incx, f2c_complex *
			cy, integer *incy, f2c_complex *c__, f2c_complex *s);
            
/* F2c_Complex */
VOID cladiv_(f2c_complex * ret_val, f2c_complex *x, f2c_complex *y);

/* Subroutine */
int claed0_(integer *qsiz, integer *n, f2c_real *d__, f2c_real *e,
...
/* Subroutine */
int claed8_(integer *k, integer *n, integer *qsiz, f2c_complex *
...
/* Subroutine */
int claesy_(f2c_complex *a, f2c_complex *b, f2c_complex *c__, f2c_complex *
			rt1, f2c_complex *rt2, f2c_complex *evscal, f2c_complex *cs1, f2c_complex *sn1);
            
/* Subroutine */
int claev2_(f2c_complex *a, f2c_complex *b, f2c_complex *c__, f2c_real *rt1,
			f2c_real *rt2, f2c_real *cs1, f2c_complex *sn1);
            
/* Subroutine */
int clag2z_(integer *m, integer *n, f2c_complex *sa, integer *
			ldsa, doublef2c_complex *a, integer *lda, integer *info);
            
/* Subroutine */
int clags2_(logical *upper, f2c_real *a1, f2c_complex *a2, f2c_real *a3,
...
/* Subroutine */
int clagtm_(char *trans, integer *n, integer *nrhs, f2c_real *
...
/* Subroutine */
int clahr2_(integer *n, integer *k, integer *nb, f2c_complex *a,
			integer *lda, f2c_complex *tau, f2c_complex *t, integer *ldt, f2c_complex *y,
			integer *ldy);
            
/* Subroutine */
int clahrd_(integer *n, integer *k, integer *nb, f2c_complex *a,
			integer *lda, f2c_complex *tau, f2c_complex *t, integer *ldt, f2c_complex *y,
			integer *ldy);
            
/* Subroutine */
int claic1_(integer *job, integer *j, f2c_complex *x, f2c_real *sest,
...
/* Subroutine */
int clapll_(integer *n, f2c_complex *x, integer *incx, f2c_complex *
			y, integer *incy, f2c_real *ssmin);
            
/* Subroutine */
int clapmt_(logical *forwrd, integer *m, integer *n, f2c_complex
...
/* Subroutine */
int claqge_(integer *m, integer *n, f2c_complex *a, integer *lda,
			f2c_real *r__, f2c_real *c__, f2c_real *rowcnd, f2c_real *colcnd, f2c_real *amax, char *
			equed);
            
/* Subroutine */
int claqhb_(char *uplo, integer *n, integer *kd, f2c_complex *ab,
			integer *ldab, f2c_real *s, f2c_real *scond, f2c_real *amax, char *equed);
            
/* Subroutine */
int claqhe_(char *uplo, integer *n, f2c_complex *a, integer *lda,
			f2c_real *s, f2c_real *scond, f2c_real *amax, char *equed);
            
/* Subroutine */
int claqhp_(char *uplo, integer *n, f2c_complex *ap, f2c_real *s,
			f2c_real *scond, f2c_real *amax, char *equed);
            
/* Subroutine */
int claqp2_(integer *m, integer *n, integer *offset, f2c_complex
...
/* Subroutine */
int claqr1_(integer *n, f2c_complex *h__, integer *ldh, f2c_complex *
...
/* Subroutine */
int claqsb_(char *uplo, integer *n, integer *kd, f2c_complex *ab,
			integer *ldab, f2c_real *s, f2c_real *scond, f2c_real *amax, char *equed);
            
/* Subroutine */
int claqsp_(char *uplo, integer *n, f2c_complex *ap, f2c_real *s,
			f2c_real *scond, f2c_real *amax, char *equed);
            
/* Subroutine */
int claqsy_(char *uplo, integer *n, f2c_complex *a, integer *lda,
			f2c_real *s, f2c_real *scond, f2c_real *amax, char *equed);
            
/* Subroutine */
int clar1v_(integer *n, integer *b1, integer *bn, f2c_real *
...
/* Subroutine */
int clar2v_(integer *n, f2c_complex *x, f2c_complex *y, f2c_complex *z__,
			integer *incx, f2c_real *c__, f2c_complex *s, integer *incc);
            
/* Subroutine */
int clarcm_(integer *m, integer *n, f2c_real *a, integer *lda,
			f2c_complex *b, integer *ldb, f2c_complex *c__, integer *ldc, f2c_real *rwork);
            
/* Subroutine */
int clarf_(char *side, integer *m, integer *n, f2c_complex *v,
...
/* Subroutine */
int clarfg_(integer *n, f2c_complex *alpha, f2c_complex *x, integer *
			incx, f2c_complex *tau);
            
/* Subroutine */
int clarfp_(integer *n, f2c_complex *alpha, f2c_complex *x, integer *
			incx, f2c_complex *tau);
...
/* Subroutine */
int clarfx_(char *side, integer *m, integer *n, f2c_complex *v,
			f2c_complex *tau, f2c_complex *c__, integer *ldc, f2c_complex *work);
            
/* Subroutine */
int clargv_(integer *n, f2c_complex *x, integer *incx, f2c_complex *
...
/* Subroutine */
int clarrv_(integer *n, f2c_real *vl, f2c_real *vu, f2c_real *d__, f2c_real *
...
/* Subroutine */
int clarscl2_(integer *m, integer *n, f2c_real *d__, f2c_complex *x,
			  integer *ldx);
              
/* Subroutine */
int clartg_(f2c_complex *f, f2c_complex *g, f2c_real *cs, f2c_complex *sn,
			f2c_complex *r__);
            
/* Subroutine */
int clartv_(integer *n, f2c_complex *x, integer *incx, f2c_complex *
...
/* Subroutine */
int clascl_(char *type__, integer *kl, integer *ku, f2c_real *
			cfrom, f2c_real *cto, integer *m, integer *n, f2c_complex *a, integer *lda,
			integer *info);
            
/* Subroutine */
int clascl2_(integer *m, integer *n, f2c_real *d__, f2c_complex *x,
			 integer *ldx);
             
/* Subroutine */
int claset_(char *uplo, integer *m, integer *n, f2c_complex *
...
/* Subroutine */
int classq_(integer *n, f2c_complex *x, integer *incx, f2c_real *
			scale, f2c_real *sumsq);
            
/* Subroutine */
int claswp_(integer *n, f2c_complex *a, integer *lda, integer *
...
/* Subroutine */
int clatdf_(integer *ijob, integer *n, f2c_complex *z__, integer
...
/* Subroutine */
int clatrd_(char *uplo, integer *n, integer *nb, f2c_complex *a,
...
/* Subroutine */
int clatrz_(integer *m, integer *n, integer *l, f2c_complex *a,
			integer *lda, f2c_complex *tau, f2c_complex *work);
            
/* Subroutine */
int clatzm_(char *side, integer *m, integer *n, f2c_complex *v,
			integer *incv, f2c_complex *tau, f2c_complex *c1, f2c_complex *c2, integer *ldc,
			f2c_complex *work);
            
/* Subroutine */
int clauu2_(char *uplo, integer *n, f2c_complex *a, integer *lda,
			integer *info);
            
/* Subroutine */
int clauum_(char *uplo, integer *n, f2c_complex *a, integer *lda,
			integer *info);
            
/* Subroutine */
int cpbcon_(char *uplo, integer *n, integer *kd, f2c_complex *ab,
			integer *ldab, f2c_real *anorm, f2c_real *rcond, f2c_complex *work, f2c_real *rwork,
			integer *info);
            
/* Subroutine */
int cpbequ_(char *uplo, integer *n, integer *kd, f2c_complex *ab,
...
/* Subroutine */
int cpbstf_(char *uplo, integer *n, integer *kd, f2c_complex *ab,
...
/* Subroutine */
int cpbtf2_(char *uplo, integer *n, integer *kd, f2c_complex *ab,
			integer *ldab, integer *info);
            
/* Subroutine */
int cpbtrf_(char *uplo, integer *n, integer *kd, f2c_complex *ab,
			integer *ldab, integer *info);
...
/* Subroutine */
int cpftrf_(char *transr, char *uplo, integer *n, f2c_complex *a,
			integer *info);
            
/* Subroutine */
int cpftri_(char *transr, char *uplo, integer *n, f2c_complex *a,
			integer *info);
            
/* Subroutine */
int cpftrs_(char *transr, char *uplo, integer *n, integer *
			nrhs, f2c_complex *a, f2c_complex *b, integer *ldb, integer *info);
            
/* Subroutine */
int cpocon_(char *uplo, integer *n, f2c_complex *a, integer *lda,
			f2c_real *anorm, f2c_real *rcond, f2c_complex *work, f2c_real *rwork, integer *info);
            
/* Subroutine */
int cpoequ_(integer *n, f2c_complex *a, integer *lda, f2c_real *s,
			f2c_real *scond, f2c_real *amax, integer *info);
            
/* Subroutine */
int cpoequb_(integer *n, f2c_complex *a, integer *lda, f2c_real *s,
			 f2c_real *scond, f2c_real *amax, integer *info);
             
/* Subroutine */
int cporfs_(char *uplo, integer *n, integer *nrhs, f2c_complex *
...
/* Subroutine */
int cposv_(char *uplo, integer *n, integer *nrhs, f2c_complex *a,
...
/* Subroutine */
int cpotf2_(char *uplo, integer *n, f2c_complex *a, integer *lda,
			integer *info);
            
/* Subroutine */
int cpotrf_(char *uplo, integer *n, f2c_complex *a, integer *lda,
			integer *info);
            
/* Subroutine */
int cpotri_(char *uplo, integer *n, f2c_complex *a, integer *lda,
			integer *info);
            
/* Subroutine */
int cpotrs_(char *uplo, integer *n, integer *nrhs, f2c_complex *
			a, integer *lda, f2c_complex *b, integer *ldb, integer *info);
            
/* Subroutine */
int cppcon_(char *uplo, integer *n, f2c_complex *ap, f2c_real *anorm,
			f2c_real *rcond, f2c_complex *work, f2c_real *rwork, integer *info);
            
/* Subroutine */
int cppequ_(char *uplo, integer *n, f2c_complex *ap, f2c_real *s,
			f2c_real *scond, f2c_real *amax, integer *info);
            
/* Subroutine */
int cpprfs_(char *uplo, integer *n, integer *nrhs, f2c_complex *
...
/* Subroutine */
int cppsv_(char *uplo, integer *n, integer *nrhs, f2c_complex *
...
/* Subroutine */
int cpptrf_(char *uplo, integer *n, f2c_complex *ap, integer *
			info);
            
/* Subroutine */
int cpptri_(char *uplo, integer *n, f2c_complex *ap, integer *
			info);
            
/* Subroutine */
int cpptrs_(char *uplo, integer *n, integer *nrhs, f2c_complex *
			ap, f2c_complex *b, integer *ldb, integer *info);
            
/* Subroutine */
int cpstf2_(char *uplo, integer *n, f2c_complex *a, integer *lda,
			integer *piv, integer *rank, f2c_real *tol, f2c_real *work, integer *info);
            
/* Subroutine */
int cpstrf_(char *uplo, integer *n, f2c_complex *a, integer *lda,
			integer *piv, integer *rank, f2c_real *tol, f2c_real *work, integer *info);
            
/* Subroutine */
int cptcon_(integer *n, f2c_real *d__, f2c_complex *e, f2c_real *anorm,
			f2c_real *rcond, f2c_real *rwork, integer *info);
            
/* Subroutine */
int cpteqr_(char *compz, integer *n, f2c_real *d__, f2c_real *e,
			f2c_complex *z__, integer *ldz, f2c_real *work, integer *info);
            
/* Subroutine */
int cptrfs_(char *uplo, integer *n, integer *nrhs, f2c_real *d__,
			f2c_complex *e, f2c_real *df, f2c_complex *ef, f2c_complex *b, integer *ldb, f2c_complex
			*x, integer *ldx, f2c_real *ferr, f2c_real *berr, f2c_complex *work, f2c_real *rwork,
			integer *info);
            
/* Subroutine */
int cptsv_(integer *n, integer *nrhs, f2c_real *d__, f2c_complex *e,
		   f2c_complex *b, integer *ldb, integer *info);
           
/* Subroutine */
int cptsvx_(char *fact, integer *n, integer *nrhs, f2c_real *d__,
			f2c_complex *e, f2c_real *df, f2c_complex *ef, f2c_complex *b, integer *ldb, f2c_complex
			*x, integer *ldx, f2c_real *rcond, f2c_real *ferr, f2c_real *berr, f2c_complex *work,
			f2c_real *rwork, integer *info);
            
/* Subroutine */
int cpttrf_(integer *n, f2c_real *d__, f2c_complex *e, integer *info);

/* Subroutine */
int cpttrs_(char *uplo, integer *n, integer *nrhs, f2c_real *d__,
			f2c_complex *e, f2c_complex *b, integer *ldb, integer *info);
            
/* Subroutine */
int cptts2_(integer *iuplo, integer *n, integer *nrhs, f2c_real *
			d__, f2c_complex *e, f2c_complex *b, integer *ldb);
            
/* Subroutine */
int crot_(integer *n, f2c_complex *cx, integer *incx, f2c_complex *
		  cy, integer *incy, f2c_real *c__, f2c_complex *s);
          
/* Subroutine */
int cspcon_(char *uplo, integer *n, f2c_complex *ap, integer *
			ipiv, f2c_real *anorm, f2c_real *rcond, f2c_complex *work, integer *info);
            
/* Subroutine */
int cspmv_(char *uplo, integer *n, f2c_complex *alpha, f2c_complex *
		   ap, f2c_complex *x, integer *incx, f2c_complex *beta, f2c_complex *y, integer *
		   incy);
           
/* Subroutine */
int cspr_(char *uplo, integer *n, f2c_complex *alpha, f2c_complex *x,
		  integer *incx, f2c_complex *ap);
          
/* Subroutine */
int csprfs_(char *uplo, integer *n, integer *nrhs, f2c_complex *
			ap, f2c_complex *afp, integer *ipiv, f2c_complex *b, integer *ldb, f2c_complex *x,
			integer *ldx, f2c_real *ferr, f2c_real *berr, f2c_complex *work, f2c_real *rwork,
			integer *info);
            
/* Subroutine */
int cspsv_(char *uplo, integer *n, integer *nrhs, f2c_complex *
		   ap, integer *ipiv, f2c_complex *b, integer *ldb, integer *info);
...
/* Subroutine */
int csptrf_(char *uplo, integer *n, f2c_complex *ap, integer *
			ipiv, integer *info);
            
/* Subroutine */
int csptri_(char *uplo, integer *n, f2c_complex *ap, integer *
			ipiv, f2c_complex *work, integer *info);
            
/* Subroutine */
int csptrs_(char *uplo, integer *n, integer *nrhs, f2c_complex *
			ap, integer *ipiv, f2c_complex *b, integer *ldb, integer *info);
            
/* Subroutine */
int csrscl_(integer *n, f2c_real *sa, f2c_complex *sx, integer *incx);

/* Subroutine */
int cstedc_(char *compz, integer *n, f2c_real *d__, f2c_real *e,
			f2c_complex *z__, integer *ldz, f2c_complex *work, integer *lwork, f2c_real *
			rwork, integer *lrwork, integer *iwork, integer *liwork, integer *
			info);
            
/* Subroutine */
int cstegr_(char *jobz, char *range, integer *n, f2c_real *d__,
...
/* Subroutine */
int cstein_(integer *n, f2c_real *d__, f2c_real *e, integer *m, f2c_real
			*w, integer *iblock, integer *isplit, f2c_complex *z__, integer *ldz,
			f2c_real *work, integer *iwork, integer *ifail, integer *info);
            
/* Subroutine */
int cstemr_(char *jobz, char *range, integer *n, f2c_real *d__,
...
/* Subroutine */
int csteqr_(char *compz, integer *n, f2c_real *d__, f2c_real *e,
			f2c_complex *z__, integer *ldz, f2c_real *work, integer *info);
            
/* Subroutine */
int csycon_(char *uplo, integer *n, f2c_complex *a, integer *lda,
			integer *ipiv, f2c_real *anorm, f2c_real *rcond, f2c_complex *work, integer *
			info);
            
/* Subroutine */
int csyequb_(char *uplo, integer *n, f2c_complex *a, integer *
			 lda, f2c_real *s, f2c_real *scond, f2c_real *amax, f2c_complex *work, integer *info);
             
/* Subroutine */
int csymv_(char *uplo, integer *n, f2c_complex *alpha, f2c_complex *
		   a, integer *lda, f2c_complex *x, integer *incx, f2c_complex *beta, f2c_complex *y,
		   integer *incy);
           
/* Subroutine */
int csyr_(char *uplo, integer *n, f2c_complex *alpha, f2c_complex *x,
		  integer *incx, f2c_complex *a, integer *lda);
          
/* Subroutine */
int csyrfs_(char *uplo, integer *n, integer *nrhs, f2c_complex *
			a, integer *lda, f2c_complex *af, integer *ldaf, integer *ipiv, f2c_complex *
			b, integer *ldb, f2c_complex *x, integer *ldx, f2c_real *ferr, f2c_real *berr,
			f2c_complex *work, f2c_real *rwork, integer *info);
            
/* Subroutine */
int csyrfsx_(char *uplo, char *equed, integer *n, integer *
			 nrhs, f2c_complex *a, integer *lda, f2c_complex *af, integer *ldaf, integer *
			 ipiv, f2c_real *s, f2c_complex *b, integer *ldb, f2c_complex *x, integer *ldx,
			 f2c_real *rcond, f2c_real *berr, integer *n_err_bnds__, f2c_real *err_bnds_norm__,
			 f2c_real *err_bnds_comp__, integer *nparams, f2c_real *params, f2c_complex *work,
...
/* Subroutine */
int csysv_(char *uplo, integer *n, integer *nrhs, f2c_complex *a,
		   integer *lda, integer *ipiv, f2c_complex *b, integer *ldb, f2c_complex *work,
		   integer *lwork, integer *info);
...
/* Subroutine */
int csytf2_(char *uplo, integer *n, f2c_complex *a, integer *lda,
			integer *ipiv, integer *info);
            
/* Subroutine */
int csytrf_(char *uplo, integer *n, f2c_complex *a, integer *lda,
			integer *ipiv, f2c_complex *work, integer *lwork, integer *info);
            
/* Subroutine */
int csytri_(char *uplo, integer *n, f2c_complex *a, integer *lda,
			integer *ipiv, f2c_complex *work, integer *info);
            
/* Subroutine */
int csytrs_(char *uplo, integer *n, integer *nrhs, f2c_complex *
			a, integer *lda, integer *ipiv, f2c_complex *b, integer *ldb, integer *
			info);
...
/* Subroutine */
int ctftri_(char *transr, char *uplo, char *diag, integer *n,
			f2c_complex *a, integer *info);
            
/* Subroutine */
int ctfttp_(char *transr, char *uplo, integer *n, f2c_complex *
			arf, f2c_complex *ap, integer *info);
            
/* Subroutine */
int ctfttr_(char *transr, char *uplo, integer *n, f2c_complex *
...
/* Subroutine */
int ctptri_(char *uplo, char *diag, integer *n, f2c_complex *ap,
			integer *info);
...
/* Subroutine */
int ctpttf_(char *transr, char *uplo, integer *n, f2c_complex *
			ap, f2c_complex *arf, integer *info);
            
/* Subroutine */
int ctpttr_(char *uplo, integer *n, f2c_complex *ap, f2c_complex *a,
...
/* Subroutine */
int ctrexc_(char *compq, integer *n, f2c_complex *t, integer *
...
/* Subroutine */
int ctrti2_(char *uplo, char *diag, integer *n, f2c_complex *a,
			integer *lda, integer *info);
            
/* Subroutine */
int ctrtri_(char *uplo, char *diag, integer *n, f2c_complex *a,
			integer *lda, integer *info);
...
/* Subroutine */
int ctrttf_(char *transr, char *uplo, integer *n, f2c_complex *a,
			integer *lda, f2c_complex *arf, integer *info);
            
/* Subroutine */
int ctrttp_(char *uplo, integer *n, f2c_complex *a, integer *lda,
			f2c_complex *ap, integer *info);
            
/* Subroutine */
int ctzrqf_(integer *m, integer *n, f2c_complex *a, integer *lda,
			f2c_complex *tau, integer *info);
            
/* Subroutine */
int ctzrzf_(integer *m, integer *n, f2c_complex *a, integer *lda,
			f2c_complex *tau, f2c_complex *work, integer *lwork, integer *info);
            
/* Subroutine */
int cung2l_(integer *m, integer *n, integer *k, f2c_complex *a,
			integer *lda, f2c_complex *tau, f2c_complex *work, integer *info);
            
/* Subroutine */
int cung2r_(integer *m, integer *n, integer *k, f2c_complex *a,
			integer *lda, f2c_complex *tau, f2c_complex *work, integer *info);
...
/* Subroutine */
int cunghr_(integer *n, integer *ilo, integer *ihi, f2c_complex *
			a, integer *lda, f2c_complex *tau, f2c_complex *work, integer *lwork, integer
			*info);
            
/* Subroutine */
int cungl2_(integer *m, integer *n, integer *k, f2c_complex *a,
			integer *lda, f2c_complex *tau, f2c_complex *work, integer *info);
            
/* Subroutine */
int cunglq_(integer *m, integer *n, integer *k, f2c_complex *a,
			integer *lda, f2c_complex *tau, f2c_complex *work, integer *lwork, integer *
			info);
            
/* Subroutine */
int cungql_(integer *m, integer *n, integer *k, f2c_complex *a,
			integer *lda, f2c_complex *tau, f2c_complex *work, integer *lwork, integer *
			info);
            
/* Subroutine */
int cungqr_(integer *m, integer *n, integer *k, f2c_complex *a,
			integer *lda, f2c_complex *tau, f2c_complex *work, integer *lwork, integer *
			info);
            
/* Subroutine */
int cungr2_(integer *m, integer *n, integer *k, f2c_complex *a,
			integer *lda, f2c_complex *tau, f2c_complex *work, integer *info);
            
/* Subroutine */
int cungrq_(integer *m, integer *n, integer *k, f2c_complex *a,
			integer *lda, f2c_complex *tau, f2c_complex *work, integer *lwork, integer *
			info);
            
/* Subroutine */
int cungtr_(char *uplo, integer *n, f2c_complex *a, integer *lda,
			f2c_complex *tau, f2c_complex *work, integer *lwork, integer *info);
...
/* Subroutine */
int cupgtr_(char *uplo, integer *n, f2c_complex *ap, f2c_complex *
...
/* Subroutine */
int dbdsdc_(char *uplo, char *compq, integer *n, doublef2c_real *
...
/* Subroutine */
int ddisna_(char *job, integer *m, integer *n, doublef2c_real *
...
/* Subroutine */
int dgeev_(char *jobvl, char *jobvr, integer *n, doublef2c_real *
...
/* Subroutine */
int dgegv_(char *jobvl, char *jobvr, integer *n, doublef2c_real *
...
/* Subroutine */
int dgelq2_(integer *m, integer *n, doublef2c_real *a, integer *
			lda, doublef2c_real *tau, doublef2c_real *work, integer *info);
            
/* Subroutine */
int dgelqf_(integer *m, integer *n, doublef2c_real *a, integer *
...
/* Subroutine */
int dgeql2_(integer *m, integer *n, doublef2c_real *a, integer *
			lda, doublef2c_real *tau, doublef2c_real *work, integer *info);
            
/* Subroutine */
int dgeqlf_(integer *m, integer *n, doublef2c_real *a, integer *
			lda, doublef2c_real *tau, doublef2c_real *work, integer *lwork, integer *info);
            
/* Subroutine */
int dgeqp3_(integer *m, integer *n, doublef2c_real *a, integer *
			lda, integer *jpvt, doublef2c_real *tau, doublef2c_real *work, integer *lwork,
			integer *info);
            
/* Subroutine */
int dgeqpf_(integer *m, integer *n, doublef2c_real *a, integer *
			lda, integer *jpvt, doublef2c_real *tau, doublef2c_real *work, integer *info);
            
/* Subroutine */
int dgeqr2_(integer *m, integer *n, doublef2c_real *a, integer *
			lda, doublef2c_real *tau, doublef2c_real *work, integer *info);
            
/* Subroutine */
int dgeqrf_(integer *m, integer *n, doublef2c_real *a, integer *
			lda, doublef2c_real *tau, doublef2c_real *work, integer *lwork, integer *info);
...
/* Subroutine */
int dgerq2_(integer *m, integer *n, doublef2c_real *a, integer *
			lda, doublef2c_real *tau, doublef2c_real *work, integer *info);
            
/* Subroutine */
int dgerqf_(integer *m, integer *n, doublef2c_real *a, integer *
			lda, doublef2c_real *tau, doublef2c_real *work, integer *lwork, integer *info);
            
/* Subroutine */
int dgesc2_(integer *n, doublef2c_real *a, integer *lda,
			doublef2c_real *rhs, integer *ipiv, integer *jpiv, doublef2c_real *scale);
            
/* Subroutine */
int dgesdd_(char *jobz, integer *m, integer *n, doublef2c_real *
...
/* Subroutine */
int dgesv_(integer *n, integer *nrhs, doublef2c_real *a, integer
...
/* Subroutine */
int dgetc2_(integer *n, doublef2c_real *a, integer *lda, integer
			*ipiv, integer *jpiv, integer *info);
            
/* Subroutine */
int dgetf2_(integer *m, integer *n, doublef2c_real *a, integer *
			lda, integer *ipiv, integer *info);
            
/* Subroutine */
int dgetrf_(integer *m, integer *n, doublef2c_real *a, integer *
			lda, integer *ipiv, integer *info);
            
/* Subroutine */
int dgetri_(integer *n, doublef2c_real *a, integer *lda, integer
...
/* Subroutine */
int dggbal_(char *job, integer *n, doublef2c_real *a, integer *
...
/* Subroutine */
int dggev_(char *jobvl, char *jobvr, integer *n, doublef2c_real *
		   a, integer *lda, doublef2c_real *b, integer *ldb, doublef2c_real *alphar,
		   doublef2c_real *alphai, doublef2c_real *beta, doublef2c_real *vl, integer *ldvl,
		   doublef2c_real *vr, integer *ldvr, doublef2c_real *work, integer *lwork,
		   integer *info);
...
/* Subroutine */
int dggglm_(integer *n, integer *m, integer *p, doublef2c_real *
...
/* Subroutine */
int dgglse_(integer *m, integer *n, integer *p, doublef2c_real *
...
/* Subroutine */
int dggqrf_(integer *n, integer *m, integer *p, doublef2c_real *
...
/* Subroutine */
int dggrqf_(integer *m, integer *p, integer *n, doublef2c_real *
			a, integer *lda, doublef2c_real *taua, doublef2c_real *b, integer *ldb,
			doublef2c_real *taub, doublef2c_real *work, integer *lwork, integer *info);
...
/* Subroutine */
int dgsvj0_(char *jobv, integer *m, integer *n, doublef2c_real *
...
/* Subroutine */
int dgtcon_(char *norm, integer *n, doublef2c_real *dl,
...
/* Subroutine */
int dgtsv_(integer *n, integer *nrhs, doublef2c_real *dl,
...
/* Subroutine */
int dgttrf_(integer *n, doublef2c_real *dl, doublef2c_real *d__,
...
/* Subroutine */
int dla_syamv__(integer *uplo, integer *n, doublef2c_real *alpha,
				doublef2c_real *a, integer *lda, doublef2c_real *x, integer *incx,
				doublef2c_real *beta, doublef2c_real *y, integer *incy);
...
/* Subroutine */
int dla_wwaddw__(integer *n, doublef2c_real *x, doublef2c_real *y,
				 doublef2c_real *w);
                 
/* Subroutine */
int dlabad_(doublef2c_real *small, doublef2c_real *large);

/* Subroutine */
int dlabrd_(integer *m, integer *n, integer *nb, doublef2c_real *
...
/* Subroutine */
int dlacn2_(integer *n, doublef2c_real *v, doublef2c_real *x,
			integer *isgn, doublef2c_real *est, integer *kase, integer *isave);
            
/* Subroutine */
int dlacon_(integer *n, doublef2c_real *v, doublef2c_real *x,
			integer *isgn, doublef2c_real *est, integer *kase);
            
/* Subroutine */
int dlacpy_(char *uplo, integer *m, integer *n, doublef2c_real *
			a, integer *lda, doublef2c_real *b, integer *ldb);
            
/* Subroutine */
int dladiv_(doublef2c_real *a, doublef2c_real *b, doublef2c_real *c__,
			doublef2c_real *d__, doublef2c_real *p, doublef2c_real *q);
            
/* Subroutine */
int dlae2_(doublef2c_real *a, doublef2c_real *b, doublef2c_real *c__,
...
/* Subroutine */
int dlaed1_(integer *n, doublef2c_real *d__, doublef2c_real *q,
			integer *ldq, integer *indxq, doublef2c_real *rho, integer *cutpnt,
			doublef2c_real *work, integer *iwork, integer *info);
            
/* Subroutine */
int dlaed2_(integer *k, integer *n, integer *n1, doublef2c_real *
...
/* Subroutine */
int dlaed3_(integer *k, integer *n, integer *n1, doublef2c_real *
...
/* Subroutine */
int dlaed4_(integer *n, integer *i__, doublef2c_real *d__,
			doublef2c_real *z__, doublef2c_real *delta, doublef2c_real *rho, doublef2c_real *dlam,
			integer *info);
            
/* Subroutine */
int dlaed5_(integer *i__, doublef2c_real *d__, doublef2c_real *z__,
			doublef2c_real *delta, doublef2c_real *rho, doublef2c_real *dlam);
            
/* Subroutine */
int dlaed6_(integer *kniter, logical *orgati, doublef2c_real *
...
/* Subroutine */
int dlag2s_(integer *m, integer *n, doublef2c_real *a, integer *
			lda, f2c_real *sa, integer *ldsa, integer *info);
            
/* Subroutine */
int dlags2_(logical *upper, doublef2c_real *a1, doublef2c_real *a2,
...
/* Subroutine */
int dlagtf_(integer *n, doublef2c_real *a, doublef2c_real *lambda,
...
/* Subroutine */
int dlahr2_(integer *n, integer *k, integer *nb, doublef2c_real *
			a, integer *lda, doublef2c_real *tau, doublef2c_real *t, integer *ldt,
			doublef2c_real *y, integer *ldy);
            
/* Subroutine */
int dlahrd_(integer *n, integer *k, integer *nb, doublef2c_real *
			a, integer *lda, doublef2c_real *tau, doublef2c_real *t, integer *ldt,
			doublef2c_real *y, integer *ldy);
            
/* Subroutine */
int dlaic1_(integer *job, integer *j, doublef2c_real *x,
...
/* Subroutine */
int dlamrg_(integer *n1, integer *n2, doublef2c_real *a, integer
...
/* Subroutine */
int dlanv2_(doublef2c_real *a, doublef2c_real *b, doublef2c_real *c__,
...
/* Subroutine */
int dlapll_(integer *n, doublef2c_real *x, integer *incx,
...
/* Subroutine */
int dlaqge_(integer *m, integer *n, doublef2c_real *a, integer *
			lda, doublef2c_real *r__, doublef2c_real *c__, doublef2c_real *rowcnd, doublef2c_real
...
/* Subroutine */
int dlaqr1_(integer *n, doublef2c_real *h__, integer *ldh,
...
/* Subroutine */
int dlaqsb_(char *uplo, integer *n, integer *kd, doublef2c_real *
			ab, integer *ldab, doublef2c_real *s, doublef2c_real *scond, doublef2c_real *amax,
			char *equed);
            
/* Subroutine */
int dlaqsp_(char *uplo, integer *n, doublef2c_real *ap,
			doublef2c_real *s, doublef2c_real *scond, doublef2c_real *amax, char *equed);
            
/* Subroutine */
int dlaqsy_(char *uplo, integer *n, doublef2c_real *a, integer *
			lda, doublef2c_real *s, doublef2c_real *scond, doublef2c_real *amax, char *equed);
            
/* Subroutine */
int dlaqtr_(logical *ltran, logical *lf2c_real, integer *n,
...
/* Subroutine */
int dlar1v_(integer *n, integer *b1, integer *bn, doublef2c_real
...
/* Subroutine */
int dlar2v_(integer *n, doublef2c_real *x, doublef2c_real *y,
			doublef2c_real *z__, integer *incx, doublef2c_real *c__, doublef2c_real *s,
			integer *incc);
            
/* Subroutine */
int dlarf_(char *side, integer *m, integer *n, doublef2c_real *v,
...
/* Subroutine */
int dlarfg_(integer *n, doublef2c_real *alpha, doublef2c_real *x,
			integer *incx, doublef2c_real *tau);
            
/* Subroutine */
int dlarfp_(integer *n, doublef2c_real *alpha, doublef2c_real *x,
			integer *incx, doublef2c_real *tau);
...
/* Subroutine */
int dlarfx_(char *side, integer *m, integer *n, doublef2c_real *
			v, doublef2c_real *tau, doublef2c_real *c__, integer *ldc, doublef2c_real *work);
            
/* Subroutine */
int dlargv_(integer *n, doublef2c_real *x, integer *incx,
...
/* Subroutine */
int dlarra_(integer *n, doublef2c_real *d__, doublef2c_real *e,
			doublef2c_real *e2, doublef2c_real *spltol, doublef2c_real *tnrm, integer *nsplit,
			integer *isplit, integer *info);
            
/* Subroutine */
int dlarrb_(integer *n, doublef2c_real *d__, doublef2c_real *lld,
...
/* Subroutine */
int dlarrc_(char *jobt, integer *n, doublef2c_real *vl,
			doublef2c_real *vu, doublef2c_real *d__, doublef2c_real *e, doublef2c_real *pivmin,
			integer *eigcnt, integer *lcnt, integer *rcnt, integer *info);
            
/* Subroutine */
int dlarrd_(char *range, char *order, integer *n, doublef2c_real
...
/* Subroutine */
int dlarre_(char *range, integer *n, doublef2c_real *vl,
...
/* Subroutine */
int dlarrf_(integer *n, doublef2c_real *d__, doublef2c_real *l,
...
/* Subroutine */
int dlarrj_(integer *n, doublef2c_real *d__, doublef2c_real *e2,
...
/* Subroutine */
int dlarrk_(integer *n, integer *iw, doublef2c_real *gl,
...
/* Subroutine */
int dlarrr_(integer *n, doublef2c_real *d__, doublef2c_real *e,
			integer *info);
            
/* Subroutine */
int dlarrv_(integer *n, doublef2c_real *vl, doublef2c_real *vu,
...
/* Subroutine */
int dlarscl2_(integer *m, integer *n, doublef2c_real *d__,
			  doublef2c_real *x, integer *ldx);
              
/* Subroutine */
int dlartg_(doublef2c_real *f, doublef2c_real *g, doublef2c_real *cs,
			doublef2c_real *sn, doublef2c_real *r__);
            
/* Subroutine */
int dlartv_(integer *n, doublef2c_real *x, integer *incx,
			doublef2c_real *y, integer *incy, doublef2c_real *c__, doublef2c_real *s, integer
			*incc);
            
/* Subroutine */
int dlaruv_(integer *iseed, integer *n, doublef2c_real *x);
...
/* Subroutine */
int dlas2_(doublef2c_real *f, doublef2c_real *g, doublef2c_real *h__,
...
/* Subroutine */
int dlascl2_(integer *m, integer *n, doublef2c_real *d__,
			 doublef2c_real *x, integer *ldx);
             
/* Subroutine */
int dlasd0_(integer *n, integer *sqre, doublef2c_real *d__,
...
/* Subroutine */
int dlasd4_(integer *n, integer *i__, doublef2c_real *d__,
			doublef2c_real *z__, doublef2c_real *delta, doublef2c_real *rho, doublef2c_real *
			sigma, doublef2c_real *work, integer *info);
            
/* Subroutine */
int dlasd5_(integer *i__, doublef2c_real *d__, doublef2c_real *z__,
...
/* Subroutine */
int dlasd8_(integer *icompq, integer *k, doublef2c_real *d__,
...
/* Subroutine */
int dlaset_(char *uplo, integer *m, integer *n, doublef2c_real *
			alpha, doublef2c_real *beta, doublef2c_real *a, integer *lda);
            
/* Subroutine */
int dlasq1_(integer *n, doublef2c_real *d__, doublef2c_real *e,
			doublef2c_real *work, integer *info);
            
/* Subroutine */
int dlasq2_(integer *n, doublef2c_real *z__, integer *info);

/* Subroutine */
int dlasq3_(integer *i0, integer *n0, doublef2c_real *z__,
...
/* Subroutine */
int dlasq4_(integer *i0, integer *n0, doublef2c_real *z__,
...
/* Subroutine */
int dlasq5_(integer *i0, integer *n0, doublef2c_real *z__,
...
/* Subroutine */
int dlasq6_(integer *i0, integer *n0, doublef2c_real *z__,
...
/* Subroutine */
int dlasrt_(char *id, integer *n, doublef2c_real *d__, integer *
			info);
            
/* Subroutine */
int dlassq_(integer *n, doublef2c_real *x, integer *incx,
			doublef2c_real *scale, doublef2c_real *sumsq);
            
/* Subroutine */
int dlasv2_(doublef2c_real *f, doublef2c_real *g, doublef2c_real *h__,
			doublef2c_real *ssmin, doublef2c_real *ssmax, doublef2c_real *snr, doublef2c_real *
			csr, doublef2c_real *snl, doublef2c_real *csl);
            
/* Subroutine */
int dlaswp_(integer *n, doublef2c_real *a, integer *lda, integer
			*k1, integer *k2, integer *ipiv, integer *incx);
...
/* Subroutine */
int dlat2s_(char *uplo, integer *n, doublef2c_real *a, integer *
			lda, f2c_real *sa, integer *ldsa, integer *info);
...
/* Subroutine */
int dlatdf_(integer *ijob, integer *n, doublef2c_real *z__,
...
/* Subroutine */
int dlatrd_(char *uplo, integer *n, integer *nb, doublef2c_real *
...
/* Subroutine */
int dlatrz_(integer *m, integer *n, integer *l, doublef2c_real *
			a, integer *lda, doublef2c_real *tau, doublef2c_real *work);
            
/* Subroutine */
int dlatzm_(char *side, integer *m, integer *n, doublef2c_real *
			v, integer *incv, doublef2c_real *tau, doublef2c_real *c1, doublef2c_real *c2,
			integer *ldc, doublef2c_real *work);
            
/* Subroutine */
int dlauu2_(char *uplo, integer *n, doublef2c_real *a, integer *
			lda, integer *info);
            
/* Subroutine */
int dlauum_(char *uplo, integer *n, doublef2c_real *a, integer *
			lda, integer *info);
            
/* Subroutine */
int dopgtr_(char *uplo, integer *n, doublef2c_real *ap,
...
/* Subroutine */
int dorg2l_(integer *m, integer *n, integer *k, doublef2c_real *
			a, integer *lda, doublef2c_real *tau, doublef2c_real *work, integer *info);
            
/* Subroutine */
int dorg2r_(integer *m, integer *n, integer *k, doublef2c_real *
			a, integer *lda, doublef2c_real *tau, doublef2c_real *work, integer *info);
...
/* Subroutine */
int dorgl2_(integer *m, integer *n, integer *k, doublef2c_real *
			a, integer *lda, doublef2c_real *tau, doublef2c_real *work, integer *info);
            
/* Subroutine */
int dorglq_(integer *m, integer *n, integer *k, doublef2c_real *
			a, integer *lda, doublef2c_real *tau, doublef2c_real *work, integer *lwork,
			integer *info);
            
/* Subroutine */
int dorgql_(integer *m, integer *n, integer *k, doublef2c_real *
			a, integer *lda, doublef2c_real *tau, doublef2c_real *work, integer *lwork,
			integer *info);
            
/* Subroutine */
int dorgqr_(integer *m, integer *n, integer *k, doublef2c_real *
			a, integer *lda, doublef2c_real *tau, doublef2c_real *work, integer *lwork,
			integer *info);
            
/* Subroutine */
int dorgr2_(integer *m, integer *n, integer *k, doublef2c_real *
			a, integer *lda, doublef2c_real *tau, doublef2c_real *work, integer *info);
            
/* Subroutine */
int dorgrq_(integer *m, integer *n, integer *k, doublef2c_real *
			a, integer *lda, doublef2c_real *tau, doublef2c_real *work, integer *lwork,
			integer *info);
            
/* Subroutine */
int dorgtr_(char *uplo, integer *n, doublef2c_real *a, integer *
			lda, doublef2c_real *tau, doublef2c_real *work, integer *lwork, integer *info);
...
/* Subroutine */
int dpbcon_(char *uplo, integer *n, integer *kd, doublef2c_real *
			ab, integer *ldab, doublef2c_real *anorm, doublef2c_real *rcond, doublef2c_real *
			work, integer *iwork, integer *info);
            
/* Subroutine */
int dpbequ_(char *uplo, integer *n, integer *kd, doublef2c_real *
			ab, integer *ldab, doublef2c_real *s, doublef2c_real *scond, doublef2c_real *amax,
			integer *info);
...
/* Subroutine */
int dpbstf_(char *uplo, integer *n, integer *kd, doublef2c_real *
...
/* Subroutine */
int dpbtf2_(char *uplo, integer *n, integer *kd, doublef2c_real *
			ab, integer *ldab, integer *info);
            
/* Subroutine */
int dpbtrf_(char *uplo, integer *n, integer *kd, doublef2c_real *
			ab, integer *ldab, integer *info);
...
/* Subroutine */
int dpftrf_(char *transr, char *uplo, integer *n, doublef2c_real
			*a, integer *info);
            
/* Subroutine */
int dpftri_(char *transr, char *uplo, integer *n, doublef2c_real
			*a, integer *info);
...
/* Subroutine */
int dpocon_(char *uplo, integer *n, doublef2c_real *a, integer *
			lda, doublef2c_real *anorm, doublef2c_real *rcond, doublef2c_real *work, integer *
			iwork, integer *info);
            
/* Subroutine */
int dpoequ_(integer *n, doublef2c_real *a, integer *lda,
			doublef2c_real *s, doublef2c_real *scond, doublef2c_real *amax, integer *info);
            
/* Subroutine */
int dpoequb_(integer *n, doublef2c_real *a, integer *lda,
			 doublef2c_real *s, doublef2c_real *scond, doublef2c_real *amax, integer *info);
...
/* Subroutine */
int dposv_(char *uplo, integer *n, integer *nrhs, doublef2c_real
...
/* Subroutine */
int dpotf2_(char *uplo, integer *n, doublef2c_real *a, integer *
			lda, integer *info);
            
/* Subroutine */
int dpotrf_(char *uplo, integer *n, doublef2c_real *a, integer *
			lda, integer *info);
            
/* Subroutine */
int dpotri_(char *uplo, integer *n, doublef2c_real *a, integer *
			lda, integer *info);
...
/* Subroutine */
int dppcon_(char *uplo, integer *n, doublef2c_real *ap,
			doublef2c_real *anorm, doublef2c_real *rcond, doublef2c_real *work, integer *
			iwork, integer *info);
            
/* Subroutine */
int dppequ_(char *uplo, integer *n, doublef2c_real *ap,
			doublef2c_real *s, doublef2c_real *scond, doublef2c_real *amax, integer *info);
...
/* Subroutine */
int dppsv_(char *uplo, integer *n, integer *nrhs, doublef2c_real
...
/* Subroutine */
int dpptrf_(char *uplo, integer *n, doublef2c_real *ap, integer *
			info);
            
/* Subroutine */
int dpptri_(char *uplo, integer *n, doublef2c_real *ap, integer *
			info);
...
/* Subroutine */
int dpstf2_(char *uplo, integer *n, doublef2c_real *a, integer *
			lda, integer *piv, integer *rank, doublef2c_real *tol, doublef2c_real *work,
			integer *info);
            
/* Subroutine */
int dpstrf_(char *uplo, integer *n, doublef2c_real *a, integer *
			lda, integer *piv, integer *rank, doublef2c_real *tol, doublef2c_real *work,
			integer *info);
            
/* Subroutine */
int dptcon_(integer *n, doublef2c_real *d__, doublef2c_real *e,
			doublef2c_real *anorm, doublef2c_real *rcond, doublef2c_real *work, integer *info);
            
/* Subroutine */
int dpteqr_(char *compz, integer *n, doublef2c_real *d__,
			doublef2c_real *e, doublef2c_real *z__, integer *ldz, doublef2c_real *work,
			integer *info);
            
/* Subroutine */
int dptrfs_(integer *n, integer *nrhs, doublef2c_real *d__,
...
/* Subroutine */
int dptsv_(integer *n, integer *nrhs, doublef2c_real *d__,
...
/* Subroutine */
int dpttrf_(integer *n, doublef2c_real *d__, doublef2c_real *e,
			integer *info);
            
/* Subroutine */
int dpttrs_(integer *n, integer *nrhs, doublef2c_real *d__,
			doublef2c_real *e, doublef2c_real *b, integer *ldb, integer *info);
            
/* Subroutine */
int dptts2_(integer *n, integer *nrhs, doublef2c_real *d__,
			doublef2c_real *e, doublef2c_real *b, integer *ldb);
            
/* Subroutine */
int drscl_(integer *n, doublef2c_real *sa, doublef2c_real *sx,
		   integer *incx);
...
/* Subroutine */
int dsgesv_(integer *n, integer *nrhs, doublef2c_real *a,
...
/* Subroutine */
int dspcon_(char *uplo, integer *n, doublef2c_real *ap, integer *
			ipiv, doublef2c_real *anorm, doublef2c_real *rcond, doublef2c_real *work, integer
			*iwork, integer *info);
            
/* Subroutine */
int dspev_(char *jobz, char *uplo, integer *n, doublef2c_real *
		   ap, doublef2c_real *w, doublef2c_real *z__, integer *ldz, doublef2c_real *work,
		   integer *info);
           
/* Subroutine */
int dspevd_(char *jobz, char *uplo, integer *n, doublef2c_real *
			ap, doublef2c_real *w, doublef2c_real *z__, integer *ldz, doublef2c_real *work,
			integer *lwork, integer *iwork, integer *liwork, integer *info);
...
/* Subroutine */
int dspsv_(char *uplo, integer *n, integer *nrhs, doublef2c_real
...
/* Subroutine */
int dsptrd_(char *uplo, integer *n, doublef2c_real *ap,
			doublef2c_real *d__, doublef2c_real *e, doublef2c_real *tau, integer *info);
            
/* Subroutine */
int dsptrf_(char *uplo, integer *n, doublef2c_real *ap, integer *
			ipiv, integer *info);
            
/* Subroutine */
int dsptri_(char *uplo, integer *n, doublef2c_real *ap, integer *
...
/* Subroutine */
int dstebz_(char *range, char *order, integer *n, doublef2c_real
...
/* Subroutine */
int dstedc_(char *compz, integer *n, doublef2c_real *d__,
			doublef2c_real *e, doublef2c_real *z__, integer *ldz, doublef2c_real *work,
			integer *lwork, integer *iwork, integer *liwork, integer *info);
            
/* Subroutine */
int dstegr_(char *jobz, char *range, integer *n, doublef2c_real *
...
/* Subroutine */
int dsteqr_(char *compz, integer *n, doublef2c_real *d__,
			doublef2c_real *e, doublef2c_real *z__, integer *ldz, doublef2c_real *work,
			integer *info);
            
/* Subroutine */
int dsterf_(integer *n, doublef2c_real *d__, doublef2c_real *e,
			integer *info);
            
/* Subroutine */
int dstev_(char *jobz, integer *n, doublef2c_real *d__,
		   doublef2c_real *e, doublef2c_real *z__, integer *ldz, doublef2c_real *work,
		   integer *info);
           
/* Subroutine */
int dstevd_(char *jobz, integer *n, doublef2c_real *d__,
			doublef2c_real *e, doublef2c_real *z__, integer *ldz, doublef2c_real *work,
			integer *lwork, integer *iwork, integer *liwork, integer *info);
            
/* Subroutine */
int dstevr_(char *jobz, char *range, integer *n, doublef2c_real *
			d__, doublef2c_real *e, doublef2c_real *vl, doublef2c_real *vu, integer *il,
			integer *iu, doublef2c_real *abstol, integer *m, doublef2c_real *w,
			doublef2c_real *z__, integer *ldz, integer *isuppz, doublef2c_real *work,
			integer *lwork, integer *iwork, integer *liwork, integer *info);
...
/* Subroutine */
int dstevx_(char *jobz, char *range, integer *n, doublef2c_real *
			d__, doublef2c_real *e, doublef2c_real *vl, doublef2c_real *vu, integer *il,
			integer *iu, doublef2c_real *abstol, integer *m, doublef2c_real *w,
			doublef2c_real *z__, integer *ldz, doublef2c_real *work, integer *iwork,
			integer *ifail, integer *info);
...
/* Subroutine */
int dsycon_(char *uplo, integer *n, doublef2c_real *a, integer *
			lda, integer *ipiv, doublef2c_real *anorm, doublef2c_real *rcond, doublef2c_real *
			work, integer *iwork, integer *info);
            
/* Subroutine */
int dsyequb_(char *uplo, integer *n, doublef2c_real *a, integer *
			 lda, doublef2c_real *s, doublef2c_real *scond, doublef2c_real *amax, doublef2c_real *
			 work, integer *info);
             
/* Subroutine */
int dsyev_(char *jobz, char *uplo, integer *n, doublef2c_real *a,
		   integer *lda, doublef2c_real *w, doublef2c_real *work, integer *lwork,
		   integer *info);
           
/* Subroutine */
int dsyevd_(char *jobz, char *uplo, integer *n, doublef2c_real *
...
/* Subroutine */
int dsysv_(char *uplo, integer *n, integer *nrhs, doublef2c_real
...
/* Subroutine */
int dsytd2_(char *uplo, integer *n, doublef2c_real *a, integer *
			lda, doublef2c_real *d__, doublef2c_real *e, doublef2c_real *tau, integer *info);
            
/* Subroutine */
int dsytf2_(char *uplo, integer *n, doublef2c_real *a, integer *
			lda, integer *ipiv, integer *info);
            
/* Subroutine */
int dsytrd_(char *uplo, integer *n, doublef2c_real *a, integer *
			lda, doublef2c_real *d__, doublef2c_real *e, doublef2c_real *tau, doublef2c_real *
			work, integer *lwork, integer *info);
            
/* Subroutine */
int dsytrf_(char *uplo, integer *n, doublef2c_real *a, integer *
			lda, integer *ipiv, doublef2c_real *work, integer *lwork, integer *info);
            
/* Subroutine */
int dsytri_(char *uplo, integer *n, doublef2c_real *a, integer *
...
/* Subroutine */
int dtfttp_(char *transr, char *uplo, integer *n, doublef2c_real
			*arf, doublef2c_real *ap, integer *info);
            
/* Subroutine */
int dtfttr_(char *transr, char *uplo, integer *n, doublef2c_real
...
/* Subroutine */
int dtptri_(char *uplo, char *diag, integer *n, doublef2c_real *
			ap, integer *info);
...
/* Subroutine */
int dtpttf_(char *transr, char *uplo, integer *n, doublef2c_real
			*ap, doublef2c_real *arf, integer *info);
            
/* Subroutine */
int dtpttr_(char *uplo, integer *n, doublef2c_real *ap,
			doublef2c_real *a, integer *lda, integer *info);
...
/* Subroutine */
int dtrexc_(char *compq, integer *n, doublef2c_real *t, integer *
...
/* Subroutine */
int dtrti2_(char *uplo, char *diag, integer *n, doublef2c_real *
			a, integer *lda, integer *info);
            
/* Subroutine */
int dtrtri_(char *uplo, char *diag, integer *n, doublef2c_real *
			a, integer *lda, integer *info);
...
/* Subroutine */
int dtrttf_(char *transr, char *uplo, integer *n, doublef2c_real
			*a, integer *lda, doublef2c_real *arf, integer *info);
            
/* Subroutine */
int dtrttp_(char *uplo, integer *n, doublef2c_real *a, integer *
			lda, doublef2c_real *ap, integer *info);
            
/* Subroutine */
int dtzrqf_(integer *m, integer *n, doublef2c_real *a, integer *
			lda, doublef2c_real *tau, integer *info);
            
/* Subroutine */
int dtzrzf_(integer *m, integer *n, doublef2c_real *a, integer *
			lda, doublef2c_real *tau, doublef2c_real *work, integer *lwork, integer *info);
...
/* Subroutine */
int sbdsdc_(char *uplo, char *compq, integer *n, f2c_real *d__,
...
/* Subroutine */
int sdisna_(char *job, integer *m, integer *n, f2c_real *d__,
...
/* Subroutine */
int sgbequb_(integer *m, integer *n, integer *kl, integer *
...
/* Subroutine */
int sgebal_(char *job, integer *n, f2c_real *a, integer *lda,
			integer *ilo, integer *ihi, f2c_real *scale, integer *info);
            
/* Subroutine */
int sgebd2_(integer *m, integer *n, f2c_real *a, integer *lda,
			f2c_real *d__, f2c_real *e, f2c_real *tauq, f2c_real *taup, f2c_real *work, integer *info);
            
/* Subroutine */
int sgebrd_(integer *m, integer *n, f2c_real *a, integer *lda,
			f2c_real *d__, f2c_real *e, f2c_real *tauq, f2c_real *taup, f2c_real *work, integer *
			lwork, integer *info);
            
/* Subroutine */
int sgecon_(char *norm, integer *n, f2c_real *a, integer *lda,
			f2c_real *anorm, f2c_real *rcond, f2c_real *work, integer *iwork, integer *info);
            
/* Subroutine */
int sgeequ_(integer *m, integer *n, f2c_real *a, integer *lda,
			f2c_real *r__, f2c_real *c__, f2c_real *rowcnd, f2c_real *colcnd, f2c_real *amax, integer
			*info);
            
/* Subroutine */
int sgeequb_(integer *m, integer *n, f2c_real *a, integer *lda,
			 f2c_real *r__, f2c_real *c__, f2c_real *rowcnd, f2c_real *colcnd, f2c_real *amax, integer
			 *info);
...
/* Subroutine */
int sgeev_(char *jobvl, char *jobvr, integer *n, f2c_real *a,
...
/* Subroutine */
int sgegs_(char *jobvsl, char *jobvsr, integer *n, f2c_real *a,
...
/* Subroutine */
int sgegv_(char *jobvl, char *jobvr, integer *n, f2c_real *a,
		   integer *lda, f2c_real *b, integer *ldb, f2c_real *alphar, f2c_real *alphai, f2c_real
		   *beta, f2c_real *vl, integer *ldvl, f2c_real *vr, integer *ldvr, f2c_real *work,
		   integer *lwork, integer *info);
           
/* Subroutine */
int sgehd2_(integer *n, integer *ilo, integer *ihi, f2c_real *a,
			integer *lda, f2c_real *tau, f2c_real *work, integer *info);
            
/* Subroutine */
int sgehrd_(integer *n, integer *ilo, integer *ihi, f2c_real *a,
...
/* Subroutine */
int sgelq2_(integer *m, integer *n, f2c_real *a, integer *lda,
			f2c_real *tau, f2c_real *work, integer *info);
            
/* Subroutine */
int sgelqf_(integer *m, integer *n, f2c_real *a, integer *lda,
...
/* Subroutine */
int sgelsd_(integer *m, integer *n, integer *nrhs, f2c_real *a,
...
/* Subroutine */
int sgelss_(integer *m, integer *n, integer *nrhs, f2c_real *a,
			integer *lda, f2c_real *b, integer *ldb, f2c_real *s, f2c_real *rcond, integer *
			rank, f2c_real *work, integer *lwork, integer *info);
            
/* Subroutine */
int sgelsx_(integer *m, integer *n, integer *nrhs, f2c_real *a,
			integer *lda, f2c_real *b, integer *ldb, integer *jpvt, f2c_real *rcond,
			integer *rank, f2c_real *work, integer *info);
            
/* Subroutine */
int sgelsy_(integer *m, integer *n, integer *nrhs, f2c_real *a,
			integer *lda, f2c_real *b, integer *ldb, integer *jpvt, f2c_real *rcond,
			integer *rank, f2c_real *work, integer *lwork, integer *info);
            
/* Subroutine */
int sgeql2_(integer *m, integer *n, f2c_real *a, integer *lda,
			f2c_real *tau, f2c_real *work, integer *info);
            
/* Subroutine */
int sgeqlf_(integer *m, integer *n, f2c_real *a, integer *lda,
			f2c_real *tau, f2c_real *work, integer *lwork, integer *info);
            
/* Subroutine */
int sgeqp3_(integer *m, integer *n, f2c_real *a, integer *lda,
			integer *jpvt, f2c_real *tau, f2c_real *work, integer *lwork, integer *info);
            
/* Subroutine */
int sgeqpf_(integer *m, integer *n, f2c_real *a, integer *lda,
			integer *jpvt, f2c_real *tau, f2c_real *work, integer *info);
            
/* Subroutine */
int sgeqr2_(integer *m, integer *n, f2c_real *a, integer *lda,
			f2c_real *tau, f2c_real *work, integer *info);
            
/* Subroutine */
int sgeqrf_(integer *m, integer *n, f2c_real *a, integer *lda,
			f2c_real *tau, f2c_real *work, integer *lwork, integer *info);
            
/* Subroutine */
int sgerfs_(char *trans, integer *n, integer *nrhs, f2c_real *a,
...
/* Subroutine */
int sgerq2_(integer *m, integer *n, f2c_real *a, integer *lda,
			f2c_real *tau, f2c_real *work, integer *info);
            
/* Subroutine */
int sgerqf_(integer *m, integer *n, f2c_real *a, integer *lda,
			f2c_real *tau, f2c_real *work, integer *lwork, integer *info);
            
/* Subroutine */
int sgesc2_(integer *n, f2c_real *a, integer *lda, f2c_real *rhs,
			integer *ipiv, integer *jpiv, f2c_real *scale);
            
/* Subroutine */
int sgesdd_(char *jobz, integer *m, integer *n, f2c_real *a,
...
/* Subroutine */
int sgesv_(integer *n, integer *nrhs, f2c_real *a, integer *lda,
...
/* Subroutine */
int sgesvj_(char *joba, char *jobu, char *jobv, integer *m,
...
/* Subroutine */
int sgetc2_(integer *n, f2c_real *a, integer *lda, integer *ipiv,
			integer *jpiv, integer *info);
            
/* Subroutine */
int sgetf2_(integer *m, integer *n, f2c_real *a, integer *lda,
			integer *ipiv, integer *info);
            
/* Subroutine */
int sgetrf_(integer *m, integer *n, f2c_real *a, integer *lda,
			integer *ipiv, integer *info);
            
/* Subroutine */
int sgetri_(integer *n, f2c_real *a, integer *lda, integer *ipiv,
			f2c_real *work, integer *lwork, integer *info);
            
/* Subroutine */
int sgetrs_(char *trans, integer *n, integer *nrhs, f2c_real *a,
...
/* Subroutine */
int sggbal_(char *job, integer *n, f2c_real *a, integer *lda,
...
/* Subroutine */
int sggev_(char *jobvl, char *jobvr, integer *n, f2c_real *a,
		   integer *lda, f2c_real *b, integer *ldb, f2c_real *alphar, f2c_real *alphai, f2c_real
		   *beta, f2c_real *vl, integer *ldvl, f2c_real *vr, integer *ldvr, f2c_real *work,
		   integer *lwork, integer *info);
...
/* Subroutine */
int sggglm_(integer *n, integer *m, integer *p, f2c_real *a,
...
/* Subroutine */
int sgglse_(integer *m, integer *n, integer *p, f2c_real *a,
			integer *lda, f2c_real *b, integer *ldb, f2c_real *c__, f2c_real *d__, f2c_real *x,
			f2c_real *work, integer *lwork, integer *info);
            
/* Subroutine */
int sggqrf_(integer *n, integer *m, integer *p, f2c_real *a,
			integer *lda, f2c_real *taua, f2c_real *b, integer *ldb, f2c_real *taub, f2c_real *
			work, integer *lwork, integer *info);
            
/* Subroutine */
int sggrqf_(integer *m, integer *p, integer *n, f2c_real *a,
			integer *lda, f2c_real *taua, f2c_real *b, integer *ldb, f2c_real *taub, f2c_real *
			work, integer *lwork, integer *info);
...
/* Subroutine */
int sgsvj0_(char *jobv, integer *m, integer *n, f2c_real *a,
...
/* Subroutine */
int sgsvj1_(char *jobv, integer *m, integer *n, integer *n1,
...
/* Subroutine */
int sgtcon_(char *norm, integer *n, f2c_real *dl, f2c_real *d__,
			f2c_real *du, f2c_real *du2, integer *ipiv, f2c_real *anorm, f2c_real *rcond, f2c_real *
			work, integer *iwork, integer *info);
            
/* Subroutine */
int sgtrfs_(char *trans, integer *n, integer *nrhs, f2c_real *dl,
			f2c_real *d__, f2c_real *du, f2c_real *dlf, f2c_real *df, f2c_real *duf, f2c_real *du2,
			integer *ipiv, f2c_real *b, integer *ldb, f2c_real *x, integer *ldx, f2c_real *
			ferr, f2c_real *berr, f2c_real *work, integer *iwork, integer *info);
            
/* Subroutine */
int sgtsv_(integer *n, integer *nrhs, f2c_real *dl, f2c_real *d__,
...
/* Subroutine */
int sgttrf_(integer *n, f2c_real *dl, f2c_real *d__, f2c_real *du, f2c_real *
			du2, integer *ipiv, integer *info);
            
/* Subroutine */
int sgttrs_(char *trans, integer *n, integer *nrhs, f2c_real *dl,
			f2c_real *d__, f2c_real *du, f2c_real *du2, integer *ipiv, f2c_real *b, integer *ldb,
			integer *info);
            
/* Subroutine */
int sgtts2_(integer *itrans, integer *n, integer *nrhs, f2c_real
...
/* Subroutine */
int sla_geamv__(integer *trans, integer *m, integer *n, f2c_real
...
/* Subroutine */
int sla_syamv__(integer *uplo, integer *n, f2c_real *alpha, f2c_real
...
/* Subroutine */
int sla_wwaddw__(integer *n, f2c_real *x, f2c_real *y, f2c_real *w);

/* Subroutine */
int slabad_(f2c_real *small, f2c_real *large);

/* Subroutine */
int slabrd_(integer *m, integer *n, integer *nb, f2c_real *a,
			integer *lda, f2c_real *d__, f2c_real *e, f2c_real *tauq, f2c_real *taup, f2c_real *x,
			integer *ldx, f2c_real *y, integer *ldy);
            
/* Subroutine */
int slacn2_(integer *n, f2c_real *v, f2c_real *x, integer *isgn,
			f2c_real *est, integer *kase, integer *isave);
            
/* Subroutine */
int slacon_(integer *n, f2c_real *v, f2c_real *x, integer *isgn,
			f2c_real *est, integer *kase);
            
/* Subroutine */
int slacpy_(char *uplo, integer *m, integer *n, f2c_real *a,
			integer *lda, f2c_real *b, integer *ldb);
            
/* Subroutine */
int sladiv_(f2c_real *a, f2c_real *b, f2c_real *c__, f2c_real *d__, f2c_real *p,
			f2c_real *q);
            
/* Subroutine */
int slae2_(f2c_real *a, f2c_real *b, f2c_real *c__, f2c_real *rt1, f2c_real *rt2);
...
/* Subroutine */
int slaed0_(integer *icompq, integer *qsiz, integer *n, f2c_real
			*d__, f2c_real *e, f2c_real *q, integer *ldq, f2c_real *qstore, integer *ldqs,
			f2c_real *work, integer *iwork, integer *info);
            
/* Subroutine */
int slaed1_(integer *n, f2c_real *d__, f2c_real *q, integer *ldq,
			integer *indxq, f2c_real *rho, integer *cutpnt, f2c_real *work, integer *
			iwork, integer *info);
            
/* Subroutine */
int slaed2_(integer *k, integer *n, integer *n1, f2c_real *d__,
...
/* Subroutine */
int slaed3_(integer *k, integer *n, integer *n1, f2c_real *d__,
...
/* Subroutine */
int slaed4_(integer *n, integer *i__, f2c_real *d__, f2c_real *z__,
			f2c_real *delta, f2c_real *rho, f2c_real *dlam, integer *info);
            
/* Subroutine */
int slaed5_(integer *i__, f2c_real *d__, f2c_real *z__, f2c_real *delta,
			f2c_real *rho, f2c_real *dlam);
            
/* Subroutine */
int slaed6_(integer *kniter, logical *orgati, f2c_real *rho,
...
/* Subroutine */
int slaev2_(f2c_real *a, f2c_real *b, f2c_real *c__, f2c_real *rt1, f2c_real *
			rt2, f2c_real *cs1, f2c_real *sn1);
            
/* Subroutine */
int slaexc_(logical *wantq, integer *n, f2c_real *t, integer *
			ldt, f2c_real *q, integer *ldq, integer *j1, integer *n1, integer *n2,
			f2c_real *work, integer *info);
            
/* Subroutine */
int slag2_(f2c_real *a, integer *lda, f2c_real *b, integer *ldb,
		   f2c_real *safmin, f2c_real *scale1, f2c_real *scale2, f2c_real *wr1, f2c_real *wr2, f2c_real *
		   wi);
           
/* Subroutine */
int slag2d_(integer *m, integer *n, f2c_real *sa, integer *ldsa,
			doublef2c_real *a, integer *lda, integer *info);
            
/* Subroutine */
int slags2_(logical *upper, f2c_real *a1, f2c_real *a2, f2c_real *a3,
			f2c_real *b1, f2c_real *b2, f2c_real *b3, f2c_real *csu, f2c_real *snu, f2c_real *csv, f2c_real *
			snv, f2c_real *csq, f2c_real *snq);
            
/* Subroutine */
int slagtf_(integer *n, f2c_real *a, f2c_real *lambda, f2c_real *b, f2c_real
			*c__, f2c_real *tol, f2c_real *d__, integer *in, integer *info);
            
/* Subroutine */
int slagtm_(char *trans, integer *n, integer *nrhs, f2c_real *
			alpha, f2c_real *dl, f2c_real *d__, f2c_real *du, f2c_real *x, integer *ldx, f2c_real *
			beta, f2c_real *b, integer *ldb);
            
/* Subroutine */
int slagts_(integer *job, integer *n, f2c_real *a, f2c_real *b, f2c_real
			*c__, f2c_real *d__, integer *in, f2c_real *y, f2c_real *tol, integer *info);
            
/* Subroutine */
int slagv2_(f2c_real *a, integer *lda, f2c_real *b, integer *ldb,
...
/* Subroutine */
int slahr2_(integer *n, integer *k, integer *nb, f2c_real *a,
			integer *lda, f2c_real *tau, f2c_real *t, integer *ldt, f2c_real *y, integer *ldy);
            
/* Subroutine */
int slahrd_(integer *n, integer *k, integer *nb, f2c_real *a,
			integer *lda, f2c_real *tau, f2c_real *t, integer *ldt, f2c_real *y, integer *ldy);
            
/* Subroutine */
int slaic1_(integer *job, integer *j, f2c_real *x, f2c_real *sest,
			f2c_real *w, f2c_real *gamma, f2c_real *sestpr, f2c_real *s, f2c_real *c__);
            
logical slaisnan_(f2c_real *sin1, f2c_real *sin2);

/* Subroutine */
int slaln2_(logical *ltrans, integer *na, integer *nw, f2c_real *
...
/* Subroutine */
int slamrg_(integer *n1, integer *n2, f2c_real *a, integer *
...
/* Subroutine */
int slanv2_(f2c_real *a, f2c_real *b, f2c_real *c__, f2c_real *d__, f2c_real *
			rt1r, f2c_real *rt1i, f2c_real *rt2r, f2c_real *rt2i, f2c_real *cs, f2c_real *sn);
            
/* Subroutine */
int slapll_(integer *n, f2c_real *x, integer *incx, f2c_real *y,
			integer *incy, f2c_real *ssmin);
            
/* Subroutine */
int slapmt_(logical *forwrd, integer *m, integer *n, f2c_real *x,
...
/* Subroutine */
int slaqge_(integer *m, integer *n, f2c_real *a, integer *lda,
			f2c_real *r__, f2c_real *c__, f2c_real *rowcnd, f2c_real *colcnd, f2c_real *amax, char *
			equed);
            
/* Subroutine */
int slaqp2_(integer *m, integer *n, integer *offset, f2c_real *a,
...
/* Subroutine */
int slaqr1_(integer *n, f2c_real *h__, integer *ldh, f2c_real *sr1,
...
/* Subroutine */
int slaqsb_(char *uplo, integer *n, integer *kd, f2c_real *ab,
			integer *ldab, f2c_real *s, f2c_real *scond, f2c_real *amax, char *equed);
            
/* Subroutine */
int slaqsp_(char *uplo, integer *n, f2c_real *ap, f2c_real *s, f2c_real *
			scond, f2c_real *amax, char *equed);
            
/* Subroutine */
int slaqsy_(char *uplo, integer *n, f2c_real *a, integer *lda,
			f2c_real *s, f2c_real *scond, f2c_real *amax, char *equed);
            
/* Subroutine */
int slaqtr_(logical *ltran, logical *lf2c_real, integer *n, f2c_real
			*t, integer *ldt, f2c_real *b, f2c_real *w, f2c_real *scale, f2c_real *x, f2c_real *work,
			integer *info);
            
/* Subroutine */
int slar1v_(integer *n, integer *b1, integer *bn, f2c_real *
			lambda, f2c_real *d__, f2c_real *l, f2c_real *ld, f2c_real *lld, f2c_real *pivmin, f2c_real *
...
/* Subroutine */
int slar2v_(integer *n, f2c_real *x, f2c_real *y, f2c_real *z__, integer
			*incx, f2c_real *c__, f2c_real *s, integer *incc);
            
/* Subroutine */
int slarf_(char *side, integer *m, integer *n, f2c_real *v,
...
/* Subroutine */
int slarfg_(integer *n, f2c_real *alpha, f2c_real *x, integer *incx,
			f2c_real *tau);
            
/* Subroutine */
int slarfp_(integer *n, f2c_real *alpha, f2c_real *x, integer *incx,
			f2c_real *tau);
...
/* Subroutine */
int slarfx_(char *side, integer *m, integer *n, f2c_real *v,
			f2c_real *tau, f2c_real *c__, integer *ldc, f2c_real *work);
            
/* Subroutine */
int slargv_(integer *n, f2c_real *x, integer *incx, f2c_real *y,
			integer *incy, f2c_real *c__, integer *incc);
            
/* Subroutine */
int slarnv_(integer *idist, integer *iseed, integer *n, f2c_real
			*x);
            
/* Subroutine */
int slarra_(integer *n, f2c_real *d__, f2c_real *e, f2c_real *e2, f2c_real *
			spltol, f2c_real *tnrm, integer *nsplit, integer *isplit, integer *info);
            
/* Subroutine */
int slarrb_(integer *n, f2c_real *d__, f2c_real *lld, integer *
...
/* Subroutine */
int slarrc_(char *jobt, integer *n, f2c_real *vl, f2c_real *vu, f2c_real
			*d__, f2c_real *e, f2c_real *pivmin, integer *eigcnt, integer *lcnt, integer *
			rcnt, integer *info);
            
/* Subroutine */
int slarrd_(char *range, char *order, integer *n, f2c_real *vl,
...
/* Subroutine */
int slarre_(char *range, integer *n, f2c_real *vl, f2c_real *vu,
...
/* Subroutine */
int slarrf_(integer *n, f2c_real *d__, f2c_real *l, f2c_real *ld,
...
/* Subroutine */
int slarrj_(integer *n, f2c_real *d__, f2c_real *e2, integer *ifirst,
...
/* Subroutine */
int slarrk_(integer *n, integer *iw, f2c_real *gl, f2c_real *gu,
			f2c_real *d__, f2c_real *e2, f2c_real *pivmin, f2c_real *reltol, f2c_real *w, f2c_real *werr,
			integer *info);
            
/* Subroutine */
int slarrr_(integer *n, f2c_real *d__, f2c_real *e, integer *info);

/* Subroutine */
int slarrv_(integer *n, f2c_real *vl, f2c_real *vu, f2c_real *d__, f2c_real *
			l, f2c_real *pivmin, integer *isplit, integer *m, integer *dol, integer *
			dou, f2c_real *minrgp, f2c_real *rtol1, f2c_real *rtol2, f2c_real *w, f2c_real *werr,
...
/* Subroutine */
int slarscl2_(integer *m, integer *n, f2c_real *d__, f2c_real *x,
			  integer *ldx);
              
/* Subroutine */
int slartg_(f2c_real *f, f2c_real *g, f2c_real *cs, f2c_real *sn, f2c_real *r__);

/* Subroutine */
int slartv_(integer *n, f2c_real *x, integer *incx, f2c_real *y,
			integer *incy, f2c_real *c__, f2c_real *s, integer *incc);
            
/* Subroutine */
int slaruv_(integer *iseed, integer *n, f2c_real *x);
...
/* Subroutine */
int slas2_(f2c_real *f, f2c_real *g, f2c_real *h__, f2c_real *ssmin, f2c_real *
		   ssmax);
           
/* Subroutine */
int slascl_(char *type__, integer *kl, integer *ku, f2c_real *
			cfrom, f2c_real *cto, integer *m, integer *n, f2c_real *a, integer *lda,
			integer *info);
            
/* Subroutine */
int slascl2_(integer *m, integer *n, f2c_real *d__, f2c_real *x,
			 integer *ldx);
             
/* Subroutine */
int slasd0_(integer *n, integer *sqre, f2c_real *d__, f2c_real *e,
			f2c_real *u, integer *ldu, f2c_real *vt, integer *ldvt, integer *smlsiz,
			integer *iwork, f2c_real *work, integer *info);
            
/* Subroutine */
int slasd1_(integer *nl, integer *nr, integer *sqre, f2c_real *
...
/* Subroutine */
int slasd4_(integer *n, integer *i__, f2c_real *d__, f2c_real *z__,
			f2c_real *delta, f2c_real *rho, f2c_real *sigma, f2c_real *work, integer *info);
            
/* Subroutine */
int slasd5_(integer *i__, f2c_real *d__, f2c_real *z__, f2c_real *delta,
...
/* Subroutine */
int slasd8_(integer *icompq, integer *k, f2c_real *d__, f2c_real *
...
/* Subroutine */
int slaset_(char *uplo, integer *m, integer *n, f2c_real *alpha,
			f2c_real *beta, f2c_real *a, integer *lda);
            
/* Subroutine */
int slasq1_(integer *n, f2c_real *d__, f2c_real *e, f2c_real *work,
			integer *info);
            
/* Subroutine */
int slasq2_(integer *n, f2c_real *z__, integer *info);

/* Subroutine */
int slasq3_(integer *i0, integer *n0, f2c_real *z__, integer *pp,
...
/* Subroutine */
int slasq4_(integer *i0, integer *n0, f2c_real *z__, integer *pp,
...
/* Subroutine */
int slasq5_(integer *i0, integer *n0, f2c_real *z__, integer *pp,
			f2c_real *tau, f2c_real *dmin__, f2c_real *dmin1, f2c_real *dmin2, f2c_real *dn, f2c_real *
			dnm1, f2c_real *dnm2, logical *ieee);
            
/* Subroutine */
int slasq6_(integer *i0, integer *n0, f2c_real *z__, integer *pp,
...
/* Subroutine */
int slasrt_(char *id, integer *n, f2c_real *d__, integer *info);

/* Subroutine */
int slassq_(integer *n, f2c_real *x, integer *incx, f2c_real *scale,
			f2c_real *sumsq);
            
/* Subroutine */
int slasv2_(f2c_real *f, f2c_real *g, f2c_real *h__, f2c_real *ssmin, f2c_real *
			ssmax, f2c_real *snr, f2c_real *csr, f2c_real *snl, f2c_real *csl);
            
/* Subroutine */
int slaswp_(integer *n, f2c_real *a, integer *lda, integer *k1,
...
/* Subroutine */
int slatdf_(integer *ijob, integer *n, f2c_real *z__, integer *
...
/* Subroutine */
int slatrd_(char *uplo, integer *n, integer *nb, f2c_real *a,
...
/* Subroutine */
int slatrz_(integer *m, integer *n, integer *l, f2c_real *a,
			integer *lda, f2c_real *tau, f2c_real *work);
            
/* Subroutine */
int slatzm_(char *side, integer *m, integer *n, f2c_real *v,
			integer *incv, f2c_real *tau, f2c_real *c1, f2c_real *c2, integer *ldc, f2c_real *
			work);
            
/* Subroutine */
int slauu2_(char *uplo, integer *n, f2c_real *a, integer *lda,
			integer *info);
            
/* Subroutine */
int slauum_(char *uplo, integer *n, f2c_real *a, integer *lda,
			integer *info);
            
/* Subroutine */
int sopgtr_(char *uplo, integer *n, f2c_real *ap, f2c_real *tau,
...
/* Subroutine */
int sorg2l_(integer *m, integer *n, integer *k, f2c_real *a,
			integer *lda, f2c_real *tau, f2c_real *work, integer *info);
            
/* Subroutine */
int sorg2r_(integer *m, integer *n, integer *k, f2c_real *a,
			integer *lda, f2c_real *tau, f2c_real *work, integer *info);
...
/* Subroutine */
int sorghr_(integer *n, integer *ilo, integer *ihi, f2c_real *a,
			integer *lda, f2c_real *tau, f2c_real *work, integer *lwork, integer *info);
            
/* Subroutine */
int sorgl2_(integer *m, integer *n, integer *k, f2c_real *a,
			integer *lda, f2c_real *tau, f2c_real *work, integer *info);
            
/* Subroutine */
int sorglq_(integer *m, integer *n, integer *k, f2c_real *a,
			integer *lda, f2c_real *tau, f2c_real *work, integer *lwork, integer *info);
            
/* Subroutine */
int sorgql_(integer *m, integer *n, integer *k, f2c_real *a,
			integer *lda, f2c_real *tau, f2c_real *work, integer *lwork, integer *info);
            
/* Subroutine */
int sorgqr_(integer *m, integer *n, integer *k, f2c_real *a,
			integer *lda, f2c_real *tau, f2c_real *work, integer *lwork, integer *info);
            
/* Subroutine */
int sorgr2_(integer *m, integer *n, integer *k, f2c_real *a,
			integer *lda, f2c_real *tau, f2c_real *work, integer *info);
            
/* Subroutine */
int sorgrq_(integer *m, integer *n, integer *k, f2c_real *a,
			integer *lda, f2c_real *tau, f2c_real *work, integer *lwork, integer *info);
            
/* Subroutine */
int sorgtr_(char *uplo, integer *n, f2c_real *a, integer *lda,
			f2c_real *tau, f2c_real *work, integer *lwork, integer *info);
...
/* Subroutine */
int spbcon_(char *uplo, integer *n, integer *kd, f2c_real *ab,
			integer *ldab, f2c_real *anorm, f2c_real *rcond, f2c_real *work, integer *iwork,
			integer *info);
            
/* Subroutine */
int spbequ_(char *uplo, integer *n, integer *kd, f2c_real *ab,
			integer *ldab, f2c_real *s, f2c_real *scond, f2c_real *amax, integer *info);
...
/* Subroutine */
int spbstf_(char *uplo, integer *n, integer *kd, f2c_real *ab,
			integer *ldab, integer *info);
...
/* Subroutine */
int spbtf2_(char *uplo, integer *n, integer *kd, f2c_real *ab,
			integer *ldab, integer *info);
            
/* Subroutine */
int spbtrf_(char *uplo, integer *n, integer *kd, f2c_real *ab,
			integer *ldab, integer *info);
...
/* Subroutine */
int spftrf_(char *transr, char *uplo, integer *n, f2c_real *a,
			integer *info);
            
/* Subroutine */
int spftri_(char *transr, char *uplo, integer *n, f2c_real *a,
			integer *info);
            
/* Subroutine */
int spftrs_(char *transr, char *uplo, integer *n, integer *
			nrhs, f2c_real *a, f2c_real *b, integer *ldb, integer *info);
            
/* Subroutine */
int spocon_(char *uplo, integer *n, f2c_real *a, integer *lda,
			f2c_real *anorm, f2c_real *rcond, f2c_real *work, integer *iwork, integer *info);
            
/* Subroutine */
int spoequ_(integer *n, f2c_real *a, integer *lda, f2c_real *s, f2c_real
			*scond, f2c_real *amax, integer *info);
            
/* Subroutine */
int spoequb_(integer *n, f2c_real *a, integer *lda, f2c_real *s,
			 f2c_real *scond, f2c_real *amax, integer *info);
             
/* Subroutine */
int sporfs_(char *uplo, integer *n, integer *nrhs, f2c_real *a,
...
/* Subroutine */
int sposv_(char *uplo, integer *n, integer *nrhs, f2c_real *a,
...
/* Subroutine */
int spotf2_(char *uplo, integer *n, f2c_real *a, integer *lda,
			integer *info);
            
/* Subroutine */
int spotrf_(char *uplo, integer *n, f2c_real *a, integer *lda,
			integer *info);
            
/* Subroutine */
int spotri_(char *uplo, integer *n, f2c_real *a, integer *lda,
			integer *info);
            
/* Subroutine */
int spotrs_(char *uplo, integer *n, integer *nrhs, f2c_real *a,
			integer *lda, f2c_real *b, integer *ldb, integer *info);
            
/* Subroutine */
int sppcon_(char *uplo, integer *n, f2c_real *ap, f2c_real *anorm,
			f2c_real *rcond, f2c_real *work, integer *iwork, integer *info);
            
/* Subroutine */
int sppequ_(char *uplo, integer *n, f2c_real *ap, f2c_real *s, f2c_real *
			scond, f2c_real *amax, integer *info);
            
/* Subroutine */
int spprfs_(char *uplo, integer *n, integer *nrhs, f2c_real *ap,
			f2c_real *afp, f2c_real *b, integer *ldb, f2c_real *x, integer *ldx, f2c_real *ferr,
			f2c_real *berr, f2c_real *work, integer *iwork, integer *info);
            
/* Subroutine */
int sppsv_(char *uplo, integer *n, integer *nrhs, f2c_real *ap,
...
/* Subroutine */
int spptrf_(char *uplo, integer *n, f2c_real *ap, integer *info);

/* Subroutine */
int spptri_(char *uplo, integer *n, f2c_real *ap, integer *info);

/* Subroutine */
int spptrs_(char *uplo, integer *n, integer *nrhs, f2c_real *ap,
			f2c_real *b, integer *ldb, integer *info);
            
/* Subroutine */
int spstf2_(char *uplo, integer *n, f2c_real *a, integer *lda,
			integer *piv, integer *rank, f2c_real *tol, f2c_real *work, integer *info);
            
/* Subroutine */
int spstrf_(char *uplo, integer *n, f2c_real *a, integer *lda,
			integer *piv, integer *rank, f2c_real *tol, f2c_real *work, integer *info);
            
/* Subroutine */
int sptcon_(integer *n, f2c_real *d__, f2c_real *e, f2c_real *anorm,
			f2c_real *rcond, f2c_real *work, integer *info);
            
/* Subroutine */
int spteqr_(char *compz, integer *n, f2c_real *d__, f2c_real *e,
			f2c_real *z__, integer *ldz, f2c_real *work, integer *info);
            
/* Subroutine */
int sptrfs_(integer *n, integer *nrhs, f2c_real *d__, f2c_real *e,
...
/* Subroutine */
int sptsv_(integer *n, integer *nrhs, f2c_real *d__, f2c_real *e,
		   f2c_real *b, integer *ldb, integer *info);
           
/* Subroutine */
int sptsvx_(char *fact, integer *n, integer *nrhs, f2c_real *d__,
...
/* Subroutine */
int spttrf_(integer *n, f2c_real *d__, f2c_real *e, integer *info);

/* Subroutine */
int spttrs_(integer *n, integer *nrhs, f2c_real *d__, f2c_real *e,
			f2c_real *b, integer *ldb, integer *info);
            
/* Subroutine */
int sptts2_(integer *n, integer *nrhs, f2c_real *d__, f2c_real *e,
			f2c_real *b, integer *ldb);
            
/* Subroutine */
int srscl_(integer *n, f2c_real *sa, f2c_real *sx, integer *incx);
...
/* Subroutine */
int ssfrk_(char *transr, char *uplo, char *trans, integer *n,
		   integer *k, f2c_real *alpha, f2c_real *a, integer *lda, f2c_real *beta, f2c_real *
		   c__);
           
/* Subroutine */
int sspcon_(char *uplo, integer *n, f2c_real *ap, integer *ipiv,
			f2c_real *anorm, f2c_real *rcond, f2c_real *work, integer *iwork, integer *info);
            
/* Subroutine */
int sspev_(char *jobz, char *uplo, integer *n, f2c_real *ap,
		   f2c_real *w, f2c_real *z__, integer *ldz, f2c_real *work, integer *info);
           
/* Subroutine */
int sspevd_(char *jobz, char *uplo, integer *n, f2c_real *ap,
...
/* Subroutine */
int sspgst_(integer *itype, char *uplo, integer *n, f2c_real *ap,
...
/* Subroutine */
int ssprfs_(char *uplo, integer *n, integer *nrhs, f2c_real *ap,
...
/* Subroutine */
int sspsv_(char *uplo, integer *n, integer *nrhs, f2c_real *ap,
		   integer *ipiv, f2c_real *b, integer *ldb, integer *info);
...
/* Subroutine */
int ssptrd_(char *uplo, integer *n, f2c_real *ap, f2c_real *d__,
			f2c_real *e, f2c_real *tau, integer *info);
            
/* Subroutine */
int ssptrf_(char *uplo, integer *n, f2c_real *ap, integer *ipiv,
			integer *info);
            
/* Subroutine */
int ssptri_(char *uplo, integer *n, f2c_real *ap, integer *ipiv,
			f2c_real *work, integer *info);
            
/* Subroutine */
int ssptrs_(char *uplo, integer *n, integer *nrhs, f2c_real *ap,
			integer *ipiv, f2c_real *b, integer *ldb, integer *info);
            
/* Subroutine */
int sstebz_(char *range, char *order, integer *n, f2c_real *vl,
...
/* Subroutine */
int sstedc_(char *compz, integer *n, f2c_real *d__, f2c_real *e,
			f2c_real *z__, integer *ldz, f2c_real *work, integer *lwork, integer *iwork,
			integer *liwork, integer *info);
            
/* Subroutine */
int sstegr_(char *jobz, char *range, integer *n, f2c_real *d__,
			f2c_real *e, f2c_real *vl, f2c_real *vu, integer *il, integer *iu, f2c_real *abstol,
			integer *m, f2c_real *w, f2c_real *z__, integer *ldz, integer *isuppz, f2c_real *
			work, integer *lwork, integer *iwork, integer *liwork, integer *info);
            
/* Subroutine */
int sstein_(integer *n, f2c_real *d__, f2c_real *e, integer *m, f2c_real
			*w, integer *iblock, integer *isplit, f2c_real *z__, integer *ldz, f2c_real *
			work, integer *iwork, integer *ifail, integer *info);
            
/* Subroutine */
int sstemr_(char *jobz, char *range, integer *n, f2c_real *d__,
			f2c_real *e, f2c_real *vl, f2c_real *vu, integer *il, integer *iu, integer *m,
...
/* Subroutine */
int ssteqr_(char *compz, integer *n, f2c_real *d__, f2c_real *e,
			f2c_real *z__, integer *ldz, f2c_real *work, integer *info);
            
/* Subroutine */
int ssterf_(integer *n, f2c_real *d__, f2c_real *e, integer *info);

/* Subroutine */
int sstev_(char *jobz, integer *n, f2c_real *d__, f2c_real *e, f2c_real *
		   z__, integer *ldz, f2c_real *work, integer *info);
           
/* Subroutine */
int sstevd_(char *jobz, integer *n, f2c_real *d__, f2c_real *e, f2c_real
			*z__, integer *ldz, f2c_real *work, integer *lwork, integer *iwork,
			integer *liwork, integer *info);
            
/* Subroutine */
int sstevr_(char *jobz, char *range, integer *n, f2c_real *d__,
			f2c_real *e, f2c_real *vl, f2c_real *vu, integer *il, integer *iu, f2c_real *abstol,
			integer *m, f2c_real *w, f2c_real *z__, integer *ldz, integer *isuppz, f2c_real *
			work, integer *lwork, integer *iwork, integer *liwork, integer *info);
            
/* Subroutine */
int sstevx_(char *jobz, char *range, integer *n, f2c_real *d__,
			f2c_real *e, f2c_real *vl, f2c_real *vu, integer *il, integer *iu, f2c_real *abstol,
			integer *m, f2c_real *w, f2c_real *z__, integer *ldz, f2c_real *work, integer *
			iwork, integer *ifail, integer *info);
            
/* Subroutine */
int ssycon_(char *uplo, integer *n, f2c_real *a, integer *lda,
			integer *ipiv, f2c_real *anorm, f2c_real *rcond, f2c_real *work, integer *iwork,
			integer *info);
            
/* Subroutine */
int ssyequb_(char *uplo, integer *n, f2c_real *a, integer *lda,
			 f2c_real *s, f2c_real *scond, f2c_real *amax, f2c_real *work, integer *info);
             
/* Subroutine */
int ssyev_(char *jobz, char *uplo, integer *n, f2c_real *a,
		   integer *lda, f2c_real *w, f2c_real *work, integer *lwork, integer *info);
           
/* Subroutine */
int ssyevd_(char *jobz, char *uplo, integer *n, f2c_real *a,
...
/* Subroutine */
int ssygs2_(integer *itype, char *uplo, integer *n, f2c_real *a,
			integer *lda, f2c_real *b, integer *ldb, integer *info);
            
/* Subroutine */
int ssygst_(integer *itype, char *uplo, integer *n, f2c_real *a,
			integer *lda, f2c_real *b, integer *ldb, integer *info);
...
/* Subroutine */
int ssyrfs_(char *uplo, integer *n, integer *nrhs, f2c_real *a,
			integer *lda, f2c_real *af, integer *ldaf, integer *ipiv, f2c_real *b,
			integer *ldb, f2c_real *x, integer *ldx, f2c_real *ferr, f2c_real *berr, f2c_real *
			work, integer *iwork, integer *info);
...
/* Subroutine */
int ssysv_(char *uplo, integer *n, integer *nrhs, f2c_real *a,
...
/* Subroutine */
int ssytd2_(char *uplo, integer *n, f2c_real *a, integer *lda,
			f2c_real *d__, f2c_real *e, f2c_real *tau, integer *info);
            
/* Subroutine */
int ssytf2_(char *uplo, integer *n, f2c_real *a, integer *lda,
			integer *ipiv, integer *info);
            
/* Subroutine */
int ssytrd_(char *uplo, integer *n, f2c_real *a, integer *lda,
			f2c_real *d__, f2c_real *e, f2c_real *tau, f2c_real *work, integer *lwork, integer *
			info);
            
/* Subroutine */
int ssytrf_(char *uplo, integer *n, f2c_real *a, integer *lda,
			integer *ipiv, f2c_real *work, integer *lwork, integer *info);
            
/* Subroutine */
int ssytri_(char *uplo, integer *n, f2c_real *a, integer *lda,
			integer *ipiv, f2c_real *work, integer *info);
            
/* Subroutine */
int ssytrs_(char *uplo, integer *n, integer *nrhs, f2c_real *a,
			integer *lda, integer *ipiv, f2c_real *b, integer *ldb, integer *info);
...
/* Subroutine */
int stftri_(char *transr, char *uplo, char *diag, integer *n,
			f2c_real *a, integer *info);
            
/* Subroutine */
int stfttp_(char *transr, char *uplo, integer *n, f2c_real *arf,
			f2c_real *ap, integer *info);
            
/* Subroutine */
int stfttr_(char *transr, char *uplo, integer *n, f2c_real *arf,
...
/* Subroutine */
int stgex2_(logical *wantq, logical *wantz, integer *n, f2c_real
...
/* Subroutine */
int stgexc_(logical *wantq, logical *wantz, integer *n, f2c_real
			*a, integer *lda, f2c_real *b, integer *ldb, f2c_real *q, integer *ldq, f2c_real *
...
/* Subroutine */
int stptri_(char *uplo, char *diag, integer *n, f2c_real *ap,
			integer *info);
...
/* Subroutine */
int stpttf_(char *transr, char *uplo, integer *n, f2c_real *ap,
			f2c_real *arf, integer *info);
            
/* Subroutine */
int stpttr_(char *uplo, integer *n, f2c_real *ap, f2c_real *a,
			integer *lda, integer *info);
...
/* Subroutine */
int strexc_(char *compq, integer *n, f2c_real *t, integer *ldt,
...
/* Subroutine */
int strti2_(char *uplo, char *diag, integer *n, f2c_real *a,
			integer *lda, integer *info);
            
/* Subroutine */
int strtri_(char *uplo, char *diag, integer *n, f2c_real *a,
			integer *lda, integer *info);
...
/* Subroutine */
int strttf_(char *transr, char *uplo, integer *n, f2c_real *a,
			integer *lda, f2c_real *arf, integer *info);
            
/* Subroutine */
int strttp_(char *uplo, integer *n, f2c_real *a, integer *lda,
			f2c_real *ap, integer *info);
            
/* Subroutine */
int stzrqf_(integer *m, integer *n, f2c_real *a, integer *lda,
			f2c_real *tau, integer *info);
            
/* Subroutine */
int stzrzf_(integer *m, integer *n, f2c_real *a, integer *lda,
			f2c_real *tau, f2c_real *work, integer *lwork, integer *info);
...
/* Subroutine */
int zcgesv_(integer *n, integer *nrhs, doublef2c_complex *a,
...
/* Subroutine */
int zcposv_(char *uplo, integer *n, integer *nrhs,
			doublef2c_complex *a, integer *lda, doublef2c_complex *b, integer *ldb,
			doublef2c_complex *x, integer *ldx, doublef2c_complex *work, f2c_complex *swork,
			doublef2c_real *rwork, integer *iter, integer *info);
            
/* Subroutine */
int zdrscl_(integer *n, doublef2c_real *sa, doublef2c_complex *sx,
			integer *incx);
...
/* Subroutine */
int zgbequb_(integer *m, integer *n, integer *kl, integer *
...
/* Subroutine */
int zgebal_(char *job, integer *n, doublef2c_complex *a, integer
			*lda, integer *ilo, integer *ihi, doublef2c_real *scale, integer *info);
            
/* Subroutine */
int zgebd2_(integer *m, integer *n, doublef2c_complex *a,
...
/* Subroutine */
int zgebrd_(integer *m, integer *n, doublef2c_complex *a,
			integer *lda, doublef2c_real *d__, doublef2c_real *e, doublef2c_complex *tauq,
			doublef2c_complex *taup, doublef2c_complex *work, integer *lwork, integer *
			info);
            
/* Subroutine */
int zgecon_(char *norm, integer *n, doublef2c_complex *a,
			integer *lda, doublef2c_real *anorm, doublef2c_real *rcond, doublef2c_complex *
			work, doublef2c_real *rwork, integer *info);
            
/* Subroutine */
int zgeequ_(integer *m, integer *n, doublef2c_complex *a,
...
/* Subroutine */
int zgeequb_(integer *m, integer *n, doublef2c_complex *a,
			 integer *lda, doublef2c_real *r__, doublef2c_real *c__, doublef2c_real *rowcnd,
			 doublef2c_real *colcnd, doublef2c_real *amax, integer *info);
...
/* Subroutine */
int zgelq2_(integer *m, integer *n, doublef2c_complex *a,
			integer *lda, doublef2c_complex *tau, doublef2c_complex *work, integer *info);
            
/* Subroutine */
int zgelqf_(integer *m, integer *n, doublef2c_complex *a,
...
/* Subroutine */
int zgeql2_(integer *m, integer *n, doublef2c_complex *a,
			integer *lda, doublef2c_complex *tau, doublef2c_complex *work, integer *info);
            
/* Subroutine */
int zgeqlf_(integer *m, integer *n, doublef2c_complex *a,
			integer *lda, doublef2c_complex *tau, doublef2c_complex *work, integer *lwork,
			integer *info);
            
/* Subroutine */
int zgeqp3_(integer *m, integer *n, doublef2c_complex *a,
			integer *lda, integer *jpvt, doublef2c_complex *tau, doublef2c_complex *work,
			integer *lwork, doublef2c_real *rwork, integer *info);
            
/* Subroutine */
int zgeqpf_(integer *m, integer *n, doublef2c_complex *a,
			integer *lda, integer *jpvt, doublef2c_complex *tau, doublef2c_complex *work,
			doublef2c_real *rwork, integer *info);
            
/* Subroutine */
int zgeqr2_(integer *m, integer *n, doublef2c_complex *a,
			integer *lda, doublef2c_complex *tau, doublef2c_complex *work, integer *info);
            
/* Subroutine */
int zgeqrf_(integer *m, integer *n, doublef2c_complex *a,
			integer *lda, doublef2c_complex *tau, doublef2c_complex *work, integer *lwork,
			integer *info);
...
/* Subroutine */
int zgerq2_(integer *m, integer *n, doublef2c_complex *a,
			integer *lda, doublef2c_complex *tau, doublef2c_complex *work, integer *info);
            
/* Subroutine */
int zgerqf_(integer *m, integer *n, doublef2c_complex *a,
			integer *lda, doublef2c_complex *tau, doublef2c_complex *work, integer *lwork,
			integer *info);
            
/* Subroutine */
int zgesc2_(integer *n, doublef2c_complex *a, integer *lda,
...
/* Subroutine */
int zgesv_(integer *n, integer *nrhs, doublef2c_complex *a,
...
/* Subroutine */
int zgetc2_(integer *n, doublef2c_complex *a, integer *lda,
			integer *ipiv, integer *jpiv, integer *info);
            
/* Subroutine */
int zgetf2_(integer *m, integer *n, doublef2c_complex *a,
			integer *lda, integer *ipiv, integer *info);
            
/* Subroutine */
int zgetrf_(integer *m, integer *n, doublef2c_complex *a,
			integer *lda, integer *ipiv, integer *info);
            
/* Subroutine */
int zgetri_(integer *n, doublef2c_complex *a, integer *lda,
...
/* Subroutine */
int zggbal_(char *job, integer *n, doublef2c_complex *a, integer
...
/* Subroutine */
int zgtcon_(char *norm, integer *n, doublef2c_complex *dl,
...
/* Subroutine */
int zgtsv_(integer *n, integer *nrhs, doublef2c_complex *dl,
...
/* Subroutine */
int zgttrf_(integer *n, doublef2c_complex *dl, doublef2c_complex *
...
/* Subroutine */
int zhetd2_(char *uplo, integer *n, doublef2c_complex *a,
			integer *lda, doublef2c_real *d__, doublef2c_real *e, doublef2c_complex *tau,
			integer *info);
            
/* Subroutine */
int zhetf2_(char *uplo, integer *n, doublef2c_complex *a,
			integer *lda, integer *ipiv, integer *info);
            
/* Subroutine */
int zhetrd_(char *uplo, integer *n, doublef2c_complex *a,
			integer *lda, doublef2c_real *d__, doublef2c_real *e, doublef2c_complex *tau,
			doublef2c_complex *work, integer *lwork, integer *info);
            
/* Subroutine */
int zhetrf_(char *uplo, integer *n, doublef2c_complex *a,
			integer *lda, integer *ipiv, doublef2c_complex *work, integer *lwork,
			integer *info);
            
/* Subroutine */
int zhetri_(char *uplo, integer *n, doublef2c_complex *a,
...
/* Subroutine */
int zhfrk_(char *transr, char *uplo, char *trans, integer *n,
...
/* Subroutine */
int zhpcon_(char *uplo, integer *n, doublef2c_complex *ap,
			integer *ipiv, doublef2c_real *anorm, doublef2c_real *rcond, doublef2c_complex *
			work, integer *info);
            
/* Subroutine */
int zhpev_(char *jobz, char *uplo, integer *n, doublef2c_complex
...
/* Subroutine */
int zhptrd_(char *uplo, integer *n, doublef2c_complex *ap,
			doublef2c_real *d__, doublef2c_real *e, doublef2c_complex *tau, integer *info);
            
/* Subroutine */
int zhptrf_(char *uplo, integer *n, doublef2c_complex *ap,
			integer *ipiv, integer *info);
            
/* Subroutine */
int zhptri_(char *uplo, integer *n, doublef2c_complex *ap,
...
/* Subroutine */
int zla_heamv__(integer *uplo, integer *n, doublef2c_real *alpha,
				doublef2c_complex *a, integer *lda, doublef2c_complex *x, integer *incx,
				doublef2c_real *beta, doublef2c_real *y, integer *incy);
...
/* Subroutine */
int zla_syamv__(integer *uplo, integer *n, doublef2c_real *alpha,
				doublef2c_complex *a, integer *lda, doublef2c_complex *x, integer *incx,
				doublef2c_real *beta, doublef2c_real *y, integer *incy);
...
/* Subroutine */
int zla_wwaddw__(integer *n, doublef2c_complex *x, doublef2c_complex
...
/* Subroutine */
int zlacgv_(integer *n, doublef2c_complex *x, integer *incx);

/* Subroutine */
int zlacn2_(integer *n, doublef2c_complex *v, doublef2c_complex *x,
			doublef2c_real *est, integer *kase, integer *isave);
            
/* Subroutine */
int zlacon_(integer *n, doublef2c_complex *v, doublef2c_complex *x,
			doublef2c_real *est, integer *kase);
            
/* Subroutine */
int zlacp2_(char *uplo, integer *m, integer *n, doublef2c_real *
...
/* Subroutine */
int zlacrm_(integer *m, integer *n, doublef2c_complex *a,
			integer *lda, doublef2c_real *b, integer *ldb, doublef2c_complex *c__,
			integer *ldc, doublef2c_real *rwork);
            
/* Subroutine */
int zlacrt_(integer *n, doublef2c_complex *cx, integer *incx,
			doublef2c_complex *cy, integer *incy, doublef2c_complex *c__, doublef2c_complex *
			s);
            
/* Double F2c_Complex */
VOID zladiv_(doublef2c_complex * ret_val, doublef2c_complex *x,
			 doublef2c_complex *y);
             
/* Subroutine */
int zlaed0_(integer *qsiz, integer *n, doublef2c_real *d__,
...
/* Subroutine */
int zlaesy_(doublef2c_complex *a, doublef2c_complex *b,
...
/* Subroutine */
int zlaev2_(doublef2c_complex *a, doublef2c_complex *b,
			doublef2c_complex *c__, doublef2c_real *rt1, doublef2c_real *rt2, doublef2c_real *cs1,
			doublef2c_complex *sn1);
            
/* Subroutine */
int zlag2c_(integer *m, integer *n, doublef2c_complex *a,
			integer *lda, f2c_complex *sa, integer *ldsa, integer *info);
            
/* Subroutine */
int zlags2_(logical *upper, doublef2c_real *a1, doublef2c_complex *
...
/* Subroutine */
int zlaic1_(integer *job, integer *j, doublef2c_complex *x,
...
/* Subroutine */
int zlapll_(integer *n, doublef2c_complex *x, integer *incx,
...
/* Subroutine */
int zlaqge_(integer *m, integer *n, doublef2c_complex *a,
			integer *lda, doublef2c_real *r__, doublef2c_real *c__, doublef2c_real *rowcnd,
...
/* Subroutine */
int zlaqhe_(char *uplo, integer *n, doublef2c_complex *a,
			integer *lda, doublef2c_real *s, doublef2c_real *scond, doublef2c_real *amax,
			char *equed);
            
/* Subroutine */
int zlaqhp_(char *uplo, integer *n, doublef2c_complex *ap,
			doublef2c_real *s, doublef2c_real *scond, doublef2c_real *amax, char *equed);
...
/* Subroutine */
int zlaqr1_(integer *n, doublef2c_complex *h__, integer *ldh,
...
/* Subroutine */
int zlaqsp_(char *uplo, integer *n, doublef2c_complex *ap,
			doublef2c_real *s, doublef2c_real *scond, doublef2c_real *amax, char *equed);
            
/* Subroutine */
int zlaqsy_(char *uplo, integer *n, doublef2c_complex *a,
			integer *lda, doublef2c_real *s, doublef2c_real *scond, doublef2c_real *amax,
			char *equed);
            
/* Subroutine */
int zlar1v_(integer *n, integer *b1, integer *bn, doublef2c_real
			*lambda, doublef2c_real *d__, doublef2c_real *l, doublef2c_real *ld, doublef2c_real *
...
/* Subroutine */
int zlar2v_(integer *n, doublef2c_complex *x, doublef2c_complex *y,
			doublef2c_complex *z__, integer *incx, doublef2c_real *c__, doublef2c_complex *s,
			integer *incc);
            
/* Subroutine */
int zlarcm_(integer *m, integer *n, doublef2c_real *a, integer *
			lda, doublef2c_complex *b, integer *ldb, doublef2c_complex *c__, integer *ldc,
			doublef2c_real *rwork);
            
/* Subroutine */
int zlarf_(char *side, integer *m, integer *n, doublef2c_complex
...
/* Subroutine */
int zlarfg_(integer *n, doublef2c_complex *alpha, doublef2c_complex *
			x, integer *incx, doublef2c_complex *tau);
            
/* Subroutine */
int zlarfp_(integer *n, doublef2c_complex *alpha, doublef2c_complex *
			x, integer *incx, doublef2c_complex *tau);
...
/* Subroutine */
int zlargv_(integer *n, doublef2c_complex *x, integer *incx,
...
/* Subroutine */
int zlarrv_(integer *n, doublef2c_real *vl, doublef2c_real *vu,
			doublef2c_real *d__, doublef2c_real *l, doublef2c_real *pivmin, integer *isplit,
			integer *m, integer *dol, integer *dou, doublef2c_real *minrgp,
			doublef2c_real *rtol1, doublef2c_real *rtol2, doublef2c_real *w, doublef2c_real *werr,
			doublef2c_real *wgap, integer *iblock, integer *indexw, doublef2c_real *gers,
...
/* Subroutine */
int zlarscl2_(integer *m, integer *n, doublef2c_real *d__,
			  doublef2c_complex *x, integer *ldx);
              
/* Subroutine */
int zlartg_(doublef2c_complex *f, doublef2c_complex *g, doublef2c_real *
			cs, doublef2c_complex *sn, doublef2c_complex *r__);
            
/* Subroutine */
int zlartv_(integer *n, doublef2c_complex *x, integer *incx,
...
/* Subroutine */
int zlascl2_(integer *m, integer *n, doublef2c_real *d__,
			 doublef2c_complex *x, integer *ldx);
...
/* Subroutine */
int zlassq_(integer *n, doublef2c_complex *x, integer *incx,
			doublef2c_real *scale, doublef2c_real *sumsq);
            
/* Subroutine */
int zlaswp_(integer *n, doublef2c_complex *a, integer *lda,
...
/* Subroutine */
int zlat2c_(char *uplo, integer *n, doublef2c_complex *a,
			integer *lda, f2c_complex *sa, integer *ldsa, integer *info);
...
/* Subroutine */
int zlatdf_(integer *ijob, integer *n, doublef2c_complex *z__,
...
/* Subroutine */
int zlauu2_(char *uplo, integer *n, doublef2c_complex *a,
			integer *lda, integer *info);
            
/* Subroutine */
int zlauum_(char *uplo, integer *n, doublef2c_complex *a,
			integer *lda, integer *info);
...
/* Subroutine */
int zpftrf_(char *transr, char *uplo, integer *n,
			doublef2c_complex *a, integer *info);
            
/* Subroutine */
int zpftri_(char *transr, char *uplo, integer *n,
			doublef2c_complex *a, integer *info);
            
/* Subroutine */
int zpftrs_(char *transr, char *uplo, integer *n, integer *
			nrhs, doublef2c_complex *a, doublef2c_complex *b, integer *ldb, integer *info);
            
/* Subroutine */
int zpocon_(char *uplo, integer *n, doublef2c_complex *a,
			integer *lda, doublef2c_real *anorm, doublef2c_real *rcond, doublef2c_complex *
			work, doublef2c_real *rwork, integer *info);
            
/* Subroutine */
int zpoequ_(integer *n, doublef2c_complex *a, integer *lda,
			doublef2c_real *s, doublef2c_real *scond, doublef2c_real *amax, integer *info);
            
/* Subroutine */
int zpoequb_(integer *n, doublef2c_complex *a, integer *lda,
			 doublef2c_real *s, doublef2c_real *scond, doublef2c_real *amax, integer *info);
...
/* Subroutine */
int zpotf2_(char *uplo, integer *n, doublef2c_complex *a,
			integer *lda, integer *info);
            
/* Subroutine */
int zpotrf_(char *uplo, integer *n, doublef2c_complex *a,
			integer *lda, integer *info);
            
/* Subroutine */
int zpotri_(char *uplo, integer *n, doublef2c_complex *a,
			integer *lda, integer *info);
...
/* Subroutine */
int zppcon_(char *uplo, integer *n, doublef2c_complex *ap,
			doublef2c_real *anorm, doublef2c_real *rcond, doublef2c_complex *work, doublef2c_real
			*rwork, integer *info);
            
/* Subroutine */
int zppequ_(char *uplo, integer *n, doublef2c_complex *ap,
			doublef2c_real *s, doublef2c_real *scond, doublef2c_real *amax, integer *info);
...
/* Subroutine */
int zpptrf_(char *uplo, integer *n, doublef2c_complex *ap,
			integer *info);
            
/* Subroutine */
int zpptri_(char *uplo, integer *n, doublef2c_complex *ap,
			integer *info);
...
/* Subroutine */
int zpstf2_(char *uplo, integer *n, doublef2c_complex *a,
			integer *lda, integer *piv, integer *rank, doublef2c_real *tol,
			doublef2c_real *work, integer *info);
            
/* Subroutine */
int zpstrf_(char *uplo, integer *n, doublef2c_complex *a,
			integer *lda, integer *piv, integer *rank, doublef2c_real *tol,
			doublef2c_real *work, integer *info);
            
/* Subroutine */
int zptcon_(integer *n, doublef2c_real *d__, doublef2c_complex *e,
			doublef2c_real *anorm, doublef2c_real *rcond, doublef2c_real *rwork, integer *
			info);
            
/* Subroutine */
int zpteqr_(char *compz, integer *n, doublef2c_real *d__,
...
/* Subroutine */
int zptsv_(integer *n, integer *nrhs, doublef2c_real *d__,
...
/* Subroutine */
int zpttrf_(integer *n, doublef2c_real *d__, doublef2c_complex *e,
			integer *info);
...
/* Subroutine */
int zrot_(integer *n, doublef2c_complex *cx, integer *incx,
		  doublef2c_complex *cy, integer *incy, doublef2c_real *c__, doublef2c_complex *s);
          
/* Subroutine */
int zspcon_(char *uplo, integer *n, doublef2c_complex *ap,
			integer *ipiv, doublef2c_real *anorm, doublef2c_real *rcond, doublef2c_complex *
			work, integer *info);
            
/* Subroutine */
int zspmv_(char *uplo, integer *n, doublef2c_complex *alpha,
		   doublef2c_complex *ap, doublef2c_complex *x, integer *incx, doublef2c_complex *
		   beta, doublef2c_complex *y, integer *incy);
           
/* Subroutine */
int zspr_(char *uplo, integer *n, doublef2c_complex *alpha,
		  doublef2c_complex *x, integer *incx, doublef2c_complex *ap);
...
/* Subroutine */
int zsptrf_(char *uplo, integer *n, doublef2c_complex *ap,
			integer *ipiv, integer *info);
            
/* Subroutine */
int zsptri_(char *uplo, integer *n, doublef2c_complex *ap,
			integer *ipiv, doublef2c_complex *work, integer *info);
...
/* Subroutine */
int zstedc_(char *compz, integer *n, doublef2c_real *d__,
			doublef2c_real *e, doublef2c_complex *z__, integer *ldz, doublef2c_complex *work,
			integer *lwork, doublef2c_real *rwork, integer *lrwork, integer *iwork,
			integer *liwork, integer *info);
            
/* Subroutine */
int zstegr_(char *jobz, char *range, integer *n, doublef2c_real *
			d__, doublef2c_real *e, doublef2c_real *vl, doublef2c_real *vu, integer *il,
			integer *iu, doublef2c_real *abstol, integer *m, doublef2c_real *w,
			doublef2c_complex *z__, integer *ldz, integer *isuppz, doublef2c_real *work,
			integer *lwork, integer *iwork, integer *liwork, integer *info);
...
/* Subroutine */
int zstein_(integer *n, doublef2c_real *d__, doublef2c_real *e,
			integer *m, doublef2c_real *w, integer *iblock, integer *isplit,
			doublef2c_complex *z__, integer *ldz, doublef2c_real *work, integer *iwork,
			integer *ifail, integer *info);
            
/* Subroutine */
int zstemr_(char *jobz, char *range, integer *n, doublef2c_real *
			d__, doublef2c_real *e, doublef2c_real *vl, doublef2c_real *vu, integer *il,
...
/* Subroutine */
int zsteqr_(char *compz, integer *n, doublef2c_real *d__,
			doublef2c_real *e, doublef2c_complex *z__, integer *ldz, doublef2c_real *work,
			integer *info);
            
/* Subroutine */
int zsycon_(char *uplo, integer *n, doublef2c_complex *a,
			integer *lda, integer *ipiv, doublef2c_real *anorm, doublef2c_real *rcond,
			doublef2c_complex *work, integer *info);
            
/* Subroutine */
int zsyequb_(char *uplo, integer *n, doublef2c_complex *a,
			 integer *lda, doublef2c_real *s, doublef2c_real *scond, doublef2c_real *amax,
			 doublef2c_complex *work, integer *info);
             
/* Subroutine */
int zsymv_(char *uplo, integer *n, doublef2c_complex *alpha,
		   doublef2c_complex *a, integer *lda, doublef2c_complex *x, integer *incx,
		   doublef2c_complex *beta, doublef2c_complex *y, integer *incy);
           
/* Subroutine */
int zsyr_(char *uplo, integer *n, doublef2c_complex *alpha,
		  doublef2c_complex *x, integer *incx, doublef2c_complex *a, integer *lda);
...
/* Subroutine */
int zsytf2_(char *uplo, integer *n, doublef2c_complex *a,
			integer *lda, integer *ipiv, integer *info);
            
/* Subroutine */
int zsytrf_(char *uplo, integer *n, doublef2c_complex *a,
			integer *lda, integer *ipiv, doublef2c_complex *work, integer *lwork,
			integer *info);
            
/* Subroutine */
int zsytri_(char *uplo, integer *n, doublef2c_complex *a,
			integer *lda, integer *ipiv, doublef2c_complex *work, integer *info);
...
/* Subroutine */
int ztftri_(char *transr, char *uplo, char *diag, integer *n,
			doublef2c_complex *a, integer *info);
            
/* Subroutine */
int ztfttp_(char *transr, char *uplo, integer *n,
			doublef2c_complex *arf, doublef2c_complex *ap, integer *info);
            
/* Subroutine */
int ztfttr_(char *transr, char *uplo, integer *n,
...
/* Subroutine */
int ztpttf_(char *transr, char *uplo, integer *n,
			doublef2c_complex *ap, doublef2c_complex *arf, integer *info);
            
/* Subroutine */
int ztpttr_(char *uplo, integer *n, doublef2c_complex *ap,
			doublef2c_complex *a, integer *lda, integer *info);
...
/* Subroutine */
int ztrexc_(char *compq, integer *n, doublef2c_complex *t,
...
/* Subroutine */
int ztrttf_(char *transr, char *uplo, integer *n,
			doublef2c_complex *a, integer *lda, doublef2c_complex *arf, integer *info);
            
/* Subroutine */
int ztrttp_(char *uplo, integer *n, doublef2c_complex *a,
			integer *lda, doublef2c_complex *ap, integer *info);
            
/* Subroutine */
int ztzrqf_(integer *m, integer *n, doublef2c_complex *a,
			integer *lda, doublef2c_complex *tau, integer *info);
            
/* Subroutine */
int ztzrzf_(integer *m, integer *n, doublef2c_complex *a,
			integer *lda, doublef2c_complex *tau, doublef2c_complex *work, integer *lwork,
			integer *info);
...
/* Subroutine */
int zungtr_(char *uplo, integer *n, doublef2c_complex *a,
			integer *lda, doublef2c_complex *tau, doublef2c_complex *work, integer *lwork,
			integer *info);
...
/* Subroutine */
int zupgtr_(char *uplo, integer *n, doublef2c_complex *ap,
...
/* Subroutine */
int slamc2_(integer *beta, integer *t, logical *rnd, f2c_real *
			eps, integer *emin, f2c_real *rmin, integer *emax, f2c_real *rmax);
            
doublef2c_real slamc3_(f2c_real *a, f2c_real *b);

/* Subroutine */
int slamc4_(integer *emin, f2c_real *start, integer *base);
...
/* Subroutine */
int dlamc4_(integer *emin, doublef2c_real *start, integer *base);

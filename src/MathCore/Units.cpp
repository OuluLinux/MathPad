...
Node SpeedOfLightVacuum = PE("299792458#(m/s)");
Node GravitationalConstant = PE("(6.67408*10^(-11))#((N*m^2)/(kg^2))");
Node PlanckConstant = PE("(6.62607015*10^(-34))#(J*s)");
Node ElementaryCharge = PE("(1.602176634*10^(-19))#C");
Node ElectricConstant = PE("(8.854*(10^(-12)))#((C^2)/(N*m^2))");
Node MagneticConstant = PE("(4*pi*10^(-7))#((T*m)/A)");
Node AvogadroConstant = PE("(6.02214076*10^(23))#(1/mol)");
Node BoltzmannConstant = PE("(1.380649*10^(-23))#(J/K)");
Node GasConstant = PE("8.314462618#(J/(mol*K))");
Node SetfanBoltzmannConstant = PE("(5.670370374419*10^(-8))#(W/(m^2*K^4))");
Node WienDisplacementConstant = PE("2.897771955#(mm/K)");
Node AtomicMassConstant = PE("(1.660*10^(-27))#kg");
Node ElectronMass = PE("(9.109*10^(-31))#kg");
Node ProtonMass = PE("(1.672*10^(-27))#kg");
Node NeutronMass = PE("(1.674*10^(-27))#kg");
Node LuminousEfficacy = PE("683#(lm/W)");
Node StandardGravity = PE("9.80665)#(m/s^2)");
Node StandardAtmosphere = PE("101325#Pa");
Node HubbleConstant = PE("69.3#(km/s/Mpc)");
Node VacuumPermittivity = PE("(8.8541878*(10^(-12)))#(F/m)");
